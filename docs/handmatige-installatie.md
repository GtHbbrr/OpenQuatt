...
Dit access point is beschikbaar tot ca. 10 minuten na het opstarten (instelvenster). Is het venster gesloten, herstart de controller dan eerst of stel Wi-Fi via USB in.
