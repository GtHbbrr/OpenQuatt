...
`).trimEnd()}catch{}return t}function Ny(e){return String(e??"").replace(/\x1b\[[0-9;]*m/g,"")}function Py(e){let t=String(e??""),r=Array.from(t.matchAll(/\x1b\[([0-9;]*)m/g));for(let i=r.length-1;i>=0;i-=1){let l=r[i][1].split(";").map(c=>Number(c)).filter(c=>Number.isFinite(c));for(let c=l.length-1;c>=0;c-=1){let d=l[c];if(d===31||d===91)return"error";if(d===33||d===93)return"warning";if(d===32||d===92)return"info";if(d===36||d===96||d===34||d===35)return"debug";if(d===37||d===90||d===38||d===97)return"verbose"}}let n=t.match(/\[(E|W|I|D|V|VV)\]/i);if(!n)return"plain";let a=n[1].toUpperCase();return a==="E"?"error":a==="W"?"warning":a==="I"?"info":a==="D"?"debug":"verbose"}function _y(e){for(;o.webServerLogEntries.length>im;)o.webServerLogEntries.shift(),e&&e.firstElementChild&&e.removeChild(e.firstElementChild)}function Oy(){return o.root?o.root.querySelector("[data-oq-webserver-log-output]"):null}function Zl(){return o.root?o.root.querySelector("[data-oq-webserver-log-scroller]"):null}function Ly(e,t){if(!(!t||e.length===0)){t.dataset.webServerLogEmpty==="true"&&(t.dataset.webServerLogEmpty="false",t.innerHTML="");for(let r of e)t.insertAdjacentHTML("beforeend",vm(r))}}function vm(e){let t=lm(e.receivedAt),r=cy(e.receivedAt);return`
  ...
  `}function jy(){let e=Bl();if(!e)return"";let t=cm(e),r=py(e),n=o.loadingEntities||!!o.busyAction;return`
...
`)}async function By(){let e=Vy();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",h();return}try{if(!await jr(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&h()}var Ky={"open-webserver-log-modal":()=>Ey(),"clear-webserver-log-output":()=>Cy(),"copy-webserver-log-output":()=>By()};function ym(e){return le(Ky,e)}function Sm(){let e=ur(),t=o.busyAction==="clear-webserver-log-history",r=!!o.busyAction||o.webServerLogHistoryLoading||!e&&!o.nativeOpen&&!o.webServerLogCsrfToken;return ee({id:"system",titleId:"oq-webserver-log-modal-title",kicker:"Diagnostiek",title:"OpenQuatt log",copy:e?"Hier zie je voorbeeldmeldingen uit de lokale preview.":"Hier zie je recente meldingen van OpenQuatt. Handig als je wilt terugzoeken wat er net gebeurde.",className:"oq-helper-modal--wide oq-helper-modal--scrollable oq-webserver-log-modal",closeAction:"close-system-modal",closeLabel:"Sluit logboek",body:`
    ...
    `})}function zy(){let e=o.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function Xl(e){return zy().includes(e)}function gi(){let e=Vr(),t=ne(),r=lt(),n=tm();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||r!=="wifi"&&r!=="eth"||!n?null:{canSwitch:y("firmwareUpdateTarget")&&Xl("alternate connection")&&y("installFirmwareUpdateTarget"),currentConnection:r,targetConnection:n,currentLabel:st(r),targetLabel:st(n),currentBuildLabel:ko(t,r),targetBuildLabel:ko(t,n)}}function fi(){let e=Vr(),t=ne(),r=om(),n=lt(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||t!=="single"&&t!=="duo"||!r||!a.includes(n)?null:{canSwitch:y("firmwareUpdateTarget")&&Xl("alternate topology")&&y("installFirmwareUpdateTarget"),currentTopology:t,targetTopology:r,currentConnection:n,targetConnection:n,currentLabel:ar(t),targetLabel:ar(r),currentBuildLabel:ko(t,n),targetBuildLabel:ko(r,n)}}function hi(e,t){let r=Vr(),n=ne(),a=lt(),i=nr(e),l=Bn(t),c=i&&i!==n,d=l&&l!==a,u=c&&d?"alternate topology and connection":c?"alternate topology":d?"alternate connection":"current build",m=r==="heatpump_controller_q"&&["single","duo"].includes(n)&&["single","duo"].includes(i)&&["wifi","eth"].includes(a)&&["wifi","eth"].includes(l),w=y("firmwareUpdateTarget"),v=Xl(u),f=y("installFirmwareUpdateTarget");return{available:m,canSwitch:m&&u!=="current build"&&w&&v&&f,targetEntityAvailable:w,targetOptionAvailable:v,installActionAvailable:f,currentTopology:n,currentConnection:a,targetTopology:i,targetConnection:l,targetOption:u,currentBuildLabel:ko(n,a),targetBuildLabel:ko(i,l)}}function $o(e=o.updateTestFirmwarePr){let t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function Gr(){let e=Vr(),t=ne(),r=lt(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(r))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};let i=`openquatt-${a.slug}-${t}-${r}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,label:`${a.label} ${l} ${st(r)}`}}function Kn(e=$o(),t=Gr()){let r=$o(e);if(!r||!t.available)return null;let a=`${`https://github.com/OpenQuatt/OpenQuatt/releases/download/pr-${r}`}/${t.otaFileName}`;return{otaUrl:a,md5Url:`${a}.md5`,label:`PR ${r} \xB7 ${t.label}`}}function Ro(){if(ut())return"Controleren";let e=qt();if(e)return e.phaseLabel;if(tc())return"Bijgewerkt";if(dr())return"Bezig";if(mr())return"Beschikbaar";let t=xm();if(t!==null&&t<=0)return"Actueel";let r=Nt();return typeof r.updateLabel=="string"&&r.updateLabel.trim()?r.updateLabel.trim():r.updateAvailable===!0?"Beschikbaar":r.updateAvailable===!1||Cm()?"Actueel":we()?"Nog niet gecontroleerd":"\u2014"}function we(){return o.entities.firmwareUpdate||null}function bi(){let e=we();return e?String(e.state??e.value??"").trim().toLowerCase():""}function Uy(){let e=o.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function zn(){return Uy().toLowerCase()}function Tm(){let e=o.entities.firmwareUpdateProgress;if(!e)return Number.NaN;let t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function ec(){let e=String(o.updateInstallTargetVersion||"").trim(),t=ce();return!e||!t?!1:Un(t,e)>=0}function Gy(e=we()||{}){let t=oo(e),r=ce(e);return!t||!r?!1:Un(r,t)>=0}function Em(){return(ec()||Gy())&&!ut()&&!Ur()&&!mr()}function Qy(){return o.updateInstallMode===""||o.updateInstallMode==="test-firmware"?!!(o.ota.id&&!o.ota.wait):!Ur()&&!dr()&&ec()}function tc(){return(o.updateInstallCompleted||Em())&&!ut()&&!qt()&&!mr()}function pr(){Re({updateInstallBusy:!1,updateInstallTargetVersion:"",updateInstallPhaseHint:"",updateInstallProgressHint:Number.NaN,updateInstallStatusPollObserved:!1,updateInstallMode:"",updateInstallTargetConnection:"",updateInstallTargetTopology:""}),rS()}function Ot(){o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.updateInstallStatusPollObserved=!1}function xe(){Re({updateManualUploadFile:null,updateManualUploadFileName:"",updateManualUploadError:""})}function ot(e={}){Re({...e.clearPr?{updateTestFirmwarePr:""}:{},updateTestFirmwareConfirmed:!1,updateTestFirmwareError:"",updateTestFirmwareBuild:null})}function Yy(){let e=zn(),t=Tm(),r=e!=="rebooting"||!o.updateInstallBusy||o.updateInstallStatusPollObserved;if((e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting")&&r){o.updateInstallPhaseHint=e,Number.isNaN(t)||(o.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(o.updateInstallBusy){if(o.updateInstallMode==="normal"&&ec()){o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100;return}o.controlNotice.includes("opnieuw is opgestart")&&(o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100)}}function Ur(){let e=zn();return e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting"}function Jy(){let e=zn();return e==="error"?"De firmware-installatie op het device is mislukt. Controleer de netwerkverbinding en probeer opnieuw.":e==="aborted"?"De firmware-installatie is door het device afgebroken. Probeer de installatie opnieuw.":""}function qt(){Yy();let e=zn(),t=e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting"&&(!o.updateInstallBusy||o.updateInstallStatusPollObserved),r=t?e:o.updateInstallPhaseHint,n=Tm(),a=Number.isNaN(o.updateInstallProgressHint)?0:Math.round(o.updateInstallProgressHint),i=t&&!Number.isNaN(n)?Math.round(n):a;return!Ur()&&!o.updateInstallBusy?null:r==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:o.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":o.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:r==="retrying"?{phaseLabel:"Opnieuw proberen",percent:0,copy:"De eerste verbinding voor de firmwaredownload mislukte. OpenQuatt probeert het automatisch nog \xE9\xE9n keer."}:r==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${et()} gedownload en ge\xEFnstalleerd.`:o.updateInstallMode==="connection-switch"?`De ${st(o.updateInstallTargetConnection)}-build wordt nu naar ${et()} verzonden.`:o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?`De ${ko(o.updateInstallTargetTopology,o.updateInstallTargetConnection)}-build wordt nu naar ${et()} verzonden.`:`Firmware wordt nu naar ${et()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${et()}.`:o.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${st(o.updateInstallTargetConnection)} is gestart.`:o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?`Opstellingswissel naar ${ar(o.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${et()}.`}}function oo(e=we()||{}){let t=String(e.latest_version||"").trim();if(t)return t;let r=String(e.value||"").trim(),n=String(e.current_version||"").trim();return r&&r!==n&&/^v/i.test(r)?r:""}function ce(e=we()||{}){let t=String(o.entities.projectVersionText?.state||o.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function Zy(e=we()||{}){let t=ce(e),r=String(e.current_version||"").trim();return!t||!r||t===r?!1:Un(t,r)>0}function oc(e=we()||{},t=Ao()){let r=String(t||"").trim().toLowerCase(),n=String(e.release_url||"").trim().toLowerCase(),a=oo(e).toLowerCase();if(!r||r==="\u2014")return!0;if(r==="dev"){if(n){if(n.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(r==="main"){if(n){if(n.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function qm(e){let r=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return r?{major:Number(r[1]),minor:Number(r[2]),patch:Number(r[3]),prereleaseTag:r[4]||"",prereleaseNumber:r[5]?Number(r[5]):null}:null}function Un(e,t){let r=qm(e),n=qm(t);if(!r||!n)return 0;if(r.major!==n.major)return r.major>n.major?1:-1;if(r.minor!==n.minor)return r.minor>n.minor?1:-1;if(r.patch!==n.patch)return r.patch>n.patch?1:-1;let a=!r.prereleaseTag,i=!n.prereleaseTag;return a!==i?a?1:-1:r.prereleaseTag!==n.prereleaseTag?r.prereleaseTag>n.prereleaseTag?1:-1:r.prereleaseNumber!==n.prereleaseNumber?(r.prereleaseNumber||0)>(n.prereleaseNumber||0)?1:-1:0}function dr(){if(Em())return!1;let e=bi();return o.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function ut(){let e=bi();return o.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function mr(){let e=bi();if(!oc())return!1;let t=xm();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:Nt().updateAvailable===!0}function Cm(){let e=bi();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||Zy()}function rc(){let e=we()||{},t=ce(e)||"\u2014",r=oc(e)?oo(e):"",n=r?Un(r,t):null;return!ut()&&n!==null&&n<=0&&(r=""),{current:t,latest:r||"\u2014"}}function xm(){let{current:e,latest:t}=rc();return e==="\u2014"||t==="\u2014"?null:Un(t,e)}function Mm(e=Ao()){let t=String(e||"").trim().toLowerCase();return Es[t]||Es.main}function Xy(){let e=String((we()||{}).release_url||"").trim(),t=Mm();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function eS(){return et()}function Ao(){return String(E("firmwareUpdateChannel")||o.entities.releaseChannelText?.state||o.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function tS(){return rc().latest!=="\u2014"}function km(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function oS(e,t=we()||{}){let r=km(e);return r?km(`${t.title||""} ${t.summary||""}`).includes(r):!0}function $m(e){return new Promise(t=>window.setTimeout(t,e))}function Qr(e=ho){let r=Date.now()+e;o.firmwareOtaQuietUntil=Math.max(Number(o.firmwareOtaQuietUntil||0),r),o.pendingEntitySyncOptions=null,Yd(),typeof St=="function"&&St(),o.firmwareOtaQuietTimer&&window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=window.setTimeout(()=>{o.firmwareOtaQuietTimer=null,o.firmwareOtaQuietUntil=0,!o.updateInstallBusy&&!o.nativeOpen&&Xs()},e)}function rS(){o.firmwareOtaQuietTimer&&(window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=null),o.firmwareOtaQuietUntil=0,o.nativeOpen||Xs()}function Am(){return o.deviceReconnectMode?ee({modalId:"reconnect",titleId:"oq-reconnect-modal-title",kicker:"Systeem",title:mp(),modalClass:"oq-helper-modal--reconnect",role:"status",ariaLive:"polite",bodyMarkup:`
      ...
      `}):""}function Gn(e=Ao()){let t=we()||{},r=ce(t);o.entities.firmwareUpdate={...t,state:"CHECKING",value:"",latest_version:"",latestVersion:"",summary:"",release_url:Mm(e),current_version:r}}async function Qn(e={}){let t=String(e.expectedBuildLabel||"").trim();for(let r=0;r<6;r+=1){await $m(r===0?900:1200),await z(Mt,"all",{forceMissing:!0});let n=oc(),a=!t||oS(t),i=tS(),l=ut(),c=Ro();if(n&&a&&(i||!l&&c!=="Nog niet gecontroleerd"))return!0}return!1}async function gr(e={}){let t=!1,r=Number.isFinite(Number(e.initialDelayMs))?Math.max(0,Number(e.initialDelayMs)):700,n=Number.isFinite(Number(e.pollDelayMs))?Math.max(250,Number(e.pollDelayMs)):1e3;for(let a=0;a<45;a+=1){await $m(a===0?r:n);try{let i=o.entities.firmwareUpdateStatus,l=o.ota.wait?[...Mt,"uptime"]:Mt;await z(l,"all",{forceMissing:!0});let c=zn();o.entities.firmwareUpdateStatus!==i&&(o.updateInstallStatusPollObserved=!0);let d=Jy();if(d){let u=new Error(d);throw u.firmwareInstallTerminal=!0,u}if(c==="rebooting"&&o.updateInstallStatusPollObserved&&So("ota"),h(),o.updateInstallMode==="connection-switch"){let u=Bn(o.updateInstallTargetConnection);if(u&&lt()===u&&!Ur()&&!dr())return Fr(),!0}else if(o.updateInstallMode==="topology-switch"){let u=nr(o.updateInstallTargetTopology);if(u&&ne()===u&&!Ur()&&!dr())return Fr(),!0}else if(o.updateInstallMode==="build-switch"){let u=nr(o.updateInstallTargetTopology),m=Bn(o.updateInstallTargetConnection);if(u&&m&&ne()===u&&lt()===m&&!Ur()&&!dr())return Fr(),!0}else if(Qy())return Fr(),!0}catch(i){if(i?.firmwareInstallTerminal)throw er(),i;t||(o.controlNotice="Wachten tot het device opnieuw is opgestart...",h(),t=!0)}}return Ir(),!1}function nS(){let e=Ao(),t=qt();if(t)return t.copy;if(tc()){let r=o.updateInstallCompletedVersion||ce()||Ao();return`${et()} draait nu op ${r}.`}return dr()?`OTA-update wordt voorbereid voor ${et()}. Het device kan kort herstarten.`:ut()?`We controleren of er op kanaal ${e} een nieuwe firmware beschikbaar is.`:mr()?"Er staat een nieuwere firmware klaar.":Cm()?`Je draait al de nieuwste firmware op kanaal ${e}.`:"Kies een kanaal en controleer of er een nieuwere firmware klaarstaat."}function Rm(){return!!(o.firmwareAdvancedOpen||o.firmwareConnectionSwitchOpen||o.firmwareTopologySwitchOpen||o.updateManualUploadOpen||o.updateTestFirmwareOpen)}function mi(e,t,r,n,a=!1){return`
      <button
    ...
    `}function lS(){if(!o.updateTestFirmwareOpen)return"";let t=!!(qt()||o.updateInstallBusy||ut()),r=$o(),n=Gr(),a=Kn(r,n),i=!!(n.available&&y("firmwareTestOtaUrl")&&y("firmwareTestOtaMd5Url")&&y("installFirmwareTestOta")),l=!!(r&&i),c=o.updateTestFirmwareBuild||null,d=n.available?n.label:n.error,u=a?n.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen.";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
  ...
  `}function mS(){if(!o.root)return;if(o.interfacePanelOpen){h();return}let e=o.root.querySelector(".oq-helper-hub--collapsed .oq-helper-hub-head-actions");if(!e)return;let t=e.querySelector(".oq-debug-recording-header-status"),r=nc();if(!r){t?.remove();return}if(t){t.outerHTML=r;return}e.insertAdjacentHTML("afterbegin",r)}function gS(){if(!o.root)return;let e=o.root.querySelector('[data-oq-diagnostics-row="debugRecording"]');if(!e)return;let t=e.querySelector(".oq-settings-system-row-value"),r=e.querySelector(".oq-settings-system-row-note");t&&(t.textContent=Yn()),r&&(r.textContent=yi())}function ac(e){let t={activity:'<svg viewBox="0 0 24 24" focusable="false"><path d="M3 12h4l2-7 4 14 2-7h6"/></svg>',status:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="4"/></svg>',clock:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="8"/><path d="M12 7v5l3 2"/></svg>',samples:'<svg viewBox="0 0 24 24" focusable="false"><path d="M4 16h3l2-7 4 9 2-5h5"/></svg>',changes:'<svg viewBox="0 0 24 24" focusable="false"><path d="M18 8a7 7 0 1 0 1 7"/><path d="M18 4v4h-4"/></svg>',file:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 3h7l4 4v14H7z"/><path d="M14 3v5h5"/></svg>',storage:'<svg viewBox="0 0 24 24" focusable="false"><ellipse cx="12" cy="6" rx="7" ry="3"/><path d="M5 6v6c0 1.7 3.1 3 7 3s7-1.3 7-3V6"/><path d="M5 12v6c0 1.7 3.1 3 7 3s7-1.3 7-3v-6"/></svg>',play:'<svg viewBox="0 0 24 24" focusable="false"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 7h10v10H7z"/></svg>',download:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 4v10"/><path d="m8 10 4 4 4-4"/><path d="M5 19h14"/></svg>',copy:'<svg viewBox="0 0 24 24" focusable="false"><rect x="8" y="8" width="10" height="10" rx="2"/><path d="M6 14H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1"/></svg>',check:'<svg viewBox="0 0 24 24" focusable="false"><path d="m5 13 4 4L19 7"/></svg>',alert:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 8v5"/><path d="M12 17h.01"/><path d="M10.3 4.7 2.8 18a2 2 0 0 0 1.7 3h15a2 2 0 0 0 1.7-3L13.7 4.7a2 2 0 0 0-3.4 0z"/></svg>'};return t[e]||t.status}function fS(e){return`<span class="oq-debug-recording-icon" aria-hidden="true">${ac(e)}</span>`}function ro(e){return`<span class="oq-debug-recording-button-icon" aria-hidden="true">${ac(e)}</span>`}function hS(){return[...Uo]}function bS(){let e=[];return Uo.forEach((t,r)=>{let n=o.entities?.[t]||{},a=String(n.uom??n.unit_of_measurement??"").trim();a&&e.push([r,a])}),e}function wS(e){return Array.isArray(e)?e.map((t,r)=>t===null?null:[r,t]).filter(Boolean):[]}function Si(){o.debugRecordingTimer&&(window.clearTimeout(o.debugRecordingTimer),o.debugRecordingTimer=null)}function hr(){o.debugRecordingDevicePollTimer&&(window.clearTimeout(o.debugRecordingDevicePollTimer),o.debugRecordingDevicePollTimer=null)}function Ho(e){return`${Ne()}/openquatt/debug-recording/${e}`}function Yr(e){let t=e&&typeof e=="object"?e:{};o.debugRecordingDeviceStatus=t,o.debugRecordingActive=!!t.active,o.debugRecordingStartedAt=t.active||Number(t.sample_count||0)>0?Date.now()-Math.max(0,Number(t.elapsed_s||0)*1e3):0,o.debugRecordingEndsAt=t.active?Date.now()+Math.max(0,Number(t.remaining_s||0)*1e3):0,o.debugRecordingLastSampleAt=Number(t.sample_count||0)>0?Date.now():0}function ic(){Yr({ok:!1,available:!1,active:!1,mode:"manual",rolling:!1,frozen:!1,storage:"unavailable",interval_s:0,duration_s:0,elapsed_s:0,remaining_s:0,sample_count:0,sample_capacity:0,estimated_size:0,buffer:"unavailable"})}async function vS(){let e=await window.fetch(Ho("status"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();return Yr(t),t}function Jn(e=2e3){hr(),o.debugRecordingActive&&(o.debugRecordingDevicePollTimer=window.setTimeout(()=>{qi({silent:!0})},Math.max(0,Number(o.systemModal==="debug-recording"?e:5e3)||0)))}async function qi(e={}){e.silent||(o.debugRecordingBusy=!0,o.debugRecordingError="",h());try{await vS(),!o.debugRecordingActive&&e.silent&&(o.debugRecordingNotice="Debugopname is afgerond."),Jn()}catch(t){ic(),o.debugRecordingError=`Status kon niet worden opgehaald. ${t.message||String(t)}`}finally{e.silent||(o.debugRecordingBusy=!1),!e.silent||o.systemModal==="debug-recording"?h():(mS(),gS())}}async function Fm(){let e=Ol(Uo,"state"),t=null;for(let r=0;r<e.length;r+=1){let n=await window.fetch(Ho(`configure?reset=${r===0?"1":"0"}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store","Content-Type":"application/x-www-form-urlencoded"},body:e[r].body});if(!n.ok)throw new Error(`configuratie HTTP ${n.status}`);t=await n.json()}if(Number(t?.entity_field_count||0)!==Uo.length)throw new Error(`onvolledige debugset (${Number(t?.entity_field_count||0)}/${Uo.length})`);return t}async function yS(e){let t=Math.max(1,Number(e)||15);Si(),hr(),ti({debugRecordingBusy:!0,debugRecordingError:"",debugRecordingNotice:"",debugRecordingSamples:[],debugRecordingEvents:[],debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingDeviceBundle:null,debugRecordingLastSampleAt:0,debugRecordingSequence:0}),h();try{await Fm();let r=await window.fetch(Ho(`start?duration_s=${encodeURIComponent(t*60)}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!r.ok)throw new Error(`HTTP ${r.status}`);let n=await r.json();Yr(n),Jn()}catch(r){ic(),o.debugRecordingError=`Debugopname kon niet worden gestart. ${r.message||String(r)}`}finally{o.debugRecordingBusy=!1,h()}}async function SS(){Si(),hr(),ti({debugRecordingBusy:!0,debugRecordingError:"",debugRecordingNotice:"",debugRecordingSamples:[],debugRecordingEvents:[],debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingDeviceBundle:null,debugRecordingLastSampleAt:0,debugRecordingSequence:0}),h();try{await Fm();let e=await window.fetch(Ho("start?rolling=1"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();Yr(t),Jn()}catch(e){ic(),o.debugRecordingError=`Rolling debug kon niet worden gestart. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,h()}}async function qS(){let e=await window.fetch(Ho("freeze"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();return Yr(t),hr(),t}async function kS(){Si(),o.debugRecordingBusy=!0,o.debugRecordingError="",h();try{await qS(),o.debugRecordingNotice="Rolling debug is gestopt. De recente buffer blijft bewaard."}catch(e){o.debugRecordingError=`Rolling debug kon niet worden gestopt. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,h()}}async function TS(e={}){Si(),hr(),o.debugRecordingBusy=!0,o.debugRecordingError="",h();try{let t=await window.fetch(Ho("stop"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();Yr(r),o.debugRecordingNotice=e.completed?"Debugopname is afgerond.":"Debugopname is gestopt."}catch(t){o.debugRecordingError=`Debugopname kon niet worden gestopt. ${t.message||String(t)}`}finally{o.debugRecordingBusy=!1,h()}}function Dm(e={}){let t=o.debugRecordingActive?Date.now():Number(o.debugRecordingLastSampleAt||Date.now());return{format:"openquatt-debug-v2",schema_version:2,kind:"openquatt_debug_recording",encoding:"column-delta-json-v2",exported_at:new Date().toISOString(),source:e.source||{},recording:{started_at:o.debugRecordingStartedAt?new Date(Number(o.debugRecordingStartedAt)).toISOString():"",ended_at:t?new Date(t).toISOString():"",active:!!o.debugRecordingActive,duration_s:o.debugRecordingStartedAt?Math.round(Math.max(0,t-Number(o.debugRecordingStartedAt))/1e3):0,interval_s:Math.round(ad/1e3),sample_count:Lt(),column_count:Uo.length,storage:"browser"},columns:hS(),units:bS(),initial:wS(o.debugRecordingInitialValues),samples:o.debugRecordingSamples||[],events:o.debugRecordingEvents||[],...e.logs?{logs:e.logs}:{}}}function wi(e){return JSON.stringify(e)}function ES(){let e=Number(o.debugRecordingDeviceStatus?.estimated_size||0);if(e>0)return e;try{return new Blob([wi(Dm())]).size}catch{return wi(Dm()).length}}function CS(e){let t=Math.max(0,Number(e)||0);return t>=1024*1024?`${(t/1024/1024).toFixed(1)} MB`:t>=1024?`${(t/1024).toFixed(1)} kB`:`${Math.round(t)} B`}function xS(e){let t=e?.exported_at||(e?.exported_at_ms?new Date(Number(e.exported_at_ms)).toISOString():new Date().toISOString()),r=String(t).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e?.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-debug-recording-${r}.oqdebug.json`}async function MS(){if(Lt()===0){o.debugRecordingError="Er is nog geen debugopname om te downloaden.",h();return}o.debugRecordingBusy=!0,o.debugRecordingError="";let e=o.debugRecordingActive&&It();h();try{let t=await window.fetch(Ho("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();o.debugRecordingDeviceBundle=r,El(xS(r),wi(r),"application/json"),Im(r),o.debugRecordingNotice=e?"Momentopname gedownload. Rolling debug loopt door.":"Supportbestand gedownload."}catch{o.debugRecordingError="Download mislukt. Probeer opnieuw of kopieer de data."}finally{o.debugRecordingBusy=!1,h()}}async function $S(){if(Lt()===0){o.debugRecordingError="Er is nog geen debugopname om te kopi\xEBren.",h();return}o.debugRecordingBusy=!0,o.debugRecordingError="";let e=o.debugRecordingActive&&It();h();try{let t=await window.fetch(Ho("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();if(o.debugRecordingDeviceBundle=r,!await jr(wi(r)))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");Im(r),o.debugRecordingNotice=e?"Momentopname gekopieerd. Rolling debug loopt door.":"Supportbestand gekopieerd."}catch{o.debugRecordingError="Kopi\xEBren mislukt. Probeer opnieuw of download het supportbestand."}finally{o.debugRecordingBusy=!1,h()}}var AS={"open-debug-recording-modal":()=>(o.systemModal="debug-recording",o.debugRecordingError="",o.debugRecordingNotice="",h(),qi()),"start-debug-recording":e=>yS(e.dataset.debugMinutes||15),"start-rolling-debug-recording":()=>SS(),"select-debug-recording-duration":e=>dS(e.dataset.debugMinutes||15),"stop-debug-recording":()=>TS(),"freeze-debug-recording":()=>kS(),"download-debug-recording":()=>MS(),"copy-debug-recording":()=>$S()};function Wm(e,t){return le(AS,e,t)}function jm(){let e=o.debugRecordingActive,t=It(),r=vi(),n=Lt(),a=o.debugRecordingBusy,i=CS(ES()),l=Array.isArray(o.debugRecordingDeviceBundle?.events)?o.debugRecordingDeviceBundle.events.length:Array.isArray(o.debugRecordingEvents)?o.debugRecordingEvents.length:0,c=uS(),d=Om(),u=Nm(),m=pS(),w=n>0,v=`${m.toFixed(1)}%`,f=[{icon:"status",label:"Status",value:Yn()},{icon:"clock",label:t?"Retentie":"Duur",value:fr(t?u:Pm())},{icon:"samples",label:"Samples",value:String(n)},{icon:"changes",label:"Statuswijzigingen",value:String(l)},{icon:"file",label:"Geschatte grootte",value:`\xB1 ${i}`},{icon:"storage",label:"Opslag",value:o.debugRecordingDeviceStatus?.available===!1?"Niet beschikbaar":"Apparaatgeheugen"}],g=o.debugRecordingError?{kind:"error",icon:"alert",text:o.debugRecordingError}:o.debugRecordingNotice?{kind:"success",icon:"check",text:o.debugRecordingNotice}:null;return ee({id:"system",titleId:"oq-debug-recording-modal-title",kicker:"Diagnostiek",title:"Debugopname",copy:yi(),className:"oq-debug-recording-modal",closeAction:"close-system-modal",closeLabel:"Sluit debugopname",body:`
    ...
    `}function Qm(){return ee({id:"system",titleId:"oq-api-security-modal-title",kicker:"Toegang",title:VS(),copy:BS(),className:"oq-helper-modal--wide",closeAction:"close-system-modal",closeLabel:"Sluit API-beveiliging popup",body:`
      ...
      `;return ee({id:"system",titleId:"oq-login-modal-title",kicker:"Systeem",title:WS(),copy:jS(),closeAction:"close-system-modal",closeLabel:"Sluit login-popup",body:`
          ${i}
          ${l}
          <div class="oq-helper-modal-grid">
    ...
    `}function Xm(){let e=y("boilerCvAssistEnabled")&&C("boilerCvAssistEnabled"),t=ci(),r=C("cm100Active"),n=String(t||"").trim().toUpperCase(),a=br(t),i=!a&&(r||n==="CM100 READY"),l=o.commissioningTaskLock==="cm100",c=o.loadingEntities||o.busyAction==="commissioningCm100Start"||o.busyAction==="commissioningCm100Stop"||l,d=!!o.pendingCommissioningCm100Start,u=c||i||a,m=c||!i,w=ir("boilerPowerTestStatus","IDLE"),v=xi(w,"boiler"),f=C("boilerPowerTestActive"),g=o.loadingEntities||o.busyAction==="boilerPowerTestStart"||o.busyAction==="boilerPowerTestAbort"||o.busyAction==="boilerPowerTestApply",p=!!(o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort||o.entities.boilerPowerTestApply),b=!!o.pendingBoilerPowerTestStart,S=o.commissioningTaskLock==="boiler",q=br(w),k=!Me(w)&&(f||b||S||Xr(w))&&!q,M=Ee("boilerRatedHeatPower"),H=Ee("boilerHeatPower"),D=R("boilerHeatPower"),W=D>0?H:k&&o.commissioningBoilerHeatPowerDisplay?o.commissioningBoilerHeatPowerDisplay:H;D>0&&(o.commissioningBoilerHeatPowerDisplay=H);let I=ir("flowAutotuneStatus","IDLE"),j=xi(I,"autotune"),x=o.loadingEntities||o.busyAction==="flowAutotuneStart"||o.busyAction==="flowAutotuneAbort"||o.busyAction==="flowAutotuneApply",P=!!(o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort||o.entities.flowAutotuneApply),N=!!o.pendingFlowAutotuneStart,_=o.commissioningTaskLock==="autotune",J=br(I),V=!Me(I)&&(N||_||Xr(I))&&!J,X=ir("airPurgeStatus","IDLE"),_e=xi(X,"purge"),Et=C("airPurgeActive"),ft=o.loadingEntities||o.busyAction==="airPurgeStart"||o.busyAction==="airPurgeAbort",so=!!(o.entities.airPurgeStart||o.entities.airPurgeAbort),Ct=!!o.pendingAirPurgeStart,Oe=o.commissioningTaskLock==="purge",pe=!Me(X)&&(Et||Ct||Oe||Xr(X)),yn=/DONE/.test(String(X||"").toUpperCase()),$r=!!(so||o.entities.airPurgeStatus||o.entities.airPurgeReturnToAuto),$=Ee("airPurgeRemaining",{decimals:0}),A=R("airPurgePhase"),B=A===1?"Rustig":A===2?"Pulsen":A===3?"Stabiliseren":_e.phase,K=ir("manualFlowStatus","IDLE"),te=C("manualFlowActive"),ae=o.loadingEntities||o.busyAction==="manualFlowStart"||o.busyAction==="manualFlowAbort",ge=!!(o.entities.manualFlowStart||o.entities.manualFlowAbort),fe=!!o.pendingManualFlowStart,ue=o.commissioningTaskLock==="manual-flow",he=!Me(K)&&(te||fe||ue||Xr(K)),Ye=ir("manualHpStatus","IDLE"),lo=C("manualHpActive"),De=o.loadingEntities||o.busyAction==="manualHpStart"||o.busyAction==="manualHpAbort",co=!!(o.entities.manualHpStart||o.entities.manualHpAbort),uo=!!o.pendingManualHpStart,Be=o.commissioningTaskLock==="manual-hp",$e=!Me(Ye)&&(lo||uo||Be||Xr(Ye)),Sn=/SAFETY STOP/.test(String(Ye||"").toUpperCase()),Ke=/STOPPING/.test(String(Ye||"").toUpperCase()),mo=ir("hpWaterCalibrationStatus","IDLE"),Bb=xi(mo,"hp-water-calibration"),zu=C("hpWaterCalibrationActive"),Ma=o.loadingEntities||o.busyAction==="hpWaterCalibrationStart"||o.busyAction==="hpWaterCalibrationAbort"||o.busyAction==="hpWaterCalibrationApply",Uu=!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort||o.entities.hpWaterCalibrationApply),$a=!!o.pendingHpWaterCalibrationStart,go=o.commissioningTaskLock==="hp-water-calibration",Je=!Me(mo)&&(zu||$a||go||Xr(mo)),Aa=/DONE|APPLIED/.test(String(mo||"").toUpperCase()),Gu=/APPLIED/.test(String(mo||"").toUpperCase()),Kb=Ee("flowKpSuggested",{decimals:5,trimTrailingZeros:!0}),zb=Ee("flowKiSuggested",{decimals:5,trimTrailingZeros:!0}),Qu=/DONE|APPLIED/.test(String(w||"").toUpperCase()),Yu=/DONE|APPLIED/.test(String(I||"").toUpperCase()),qs=i?q?"Wachten op CM100":k?v.phase:Qu?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",ks=i?J?"Wachten op CM100":V?j.phase:Yu?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",Ts=i?pe?_e.phase:yn?"Klaar":"Klaar om te starten":"Wachten op CM100",Ju=i?he?"Actief":"Klaar om te starten":"Wachten op CM100",Zu=i?$e?Ke?"Bezig met stoppen":Sn?"Veiligheidsstop":"Actief":"Klaar om te starten":"Wachten op CM100",Xu=i?Je?Bb.phase:Gu?"Offsets toegepast":Aa?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",ed=!i||g||!p||V||pe||he||$e||Je||k||_||Oe||ue||Be||go||b,Ub=g||!(k||S||b),Gb=g||ed||!Qu||V||pe||Je,td=!i||x||!P||k||pe||he||$e||Je||V||S||Oe||ue||Be||go||N,Qb=x||!(V||_||N),Yb=x||td||!Yu||k||pe||Je,Jb=!i||ft||!so||k||V||he||$e||Je||pe||S||_||ue||Be||go||Ct,Zb=ft||!(pe||Oe||Ct),Xb=!i||ae||!ge||k||V||pe||$e||Je||he||S||_||Oe||Be||go||fe,ew=ae||!(he||ue||fe),tw=!i||De||!co||k||V||pe||he||Je||$e||S||_||Oe||ue||go||uo,ow=De||!($e||Be||uo),rw=!i||Ma||!Uu||k||V||pe||he||$e||Je||S||_||Oe||ue||Be||$a,nw=Ma||!(Je||go||$a),aw=Ma||Je||!Aa||Gu;d&&i&&(o.pendingCommissioningCm100Start=!1),l&&(i||/READY|STOPPED|DONE|FAILED|ABORT|APPLIED|REFUSED/.test(n))&&(o.commissioningTaskLock=""),b&&(f||Me(w))&&(o.pendingBoilerPowerTestStart=!1),S&&Me(w)&&(o.commissioningTaskLock=""),N&&Me(I)&&(o.pendingFlowAutotuneStart=!1),_&&Me(I)&&(o.commissioningTaskLock=""),Ct&&(Et||Me(X))&&(o.pendingAirPurgeStart=!1),Oe&&Me(X)&&(o.commissioningTaskLock=""),fe&&(te||Me(K))&&(o.pendingManualFlowStart=!1),ue&&(te||Me(K))&&(o.commissioningTaskLock=""),uo&&(lo||Me(Ye))&&(o.pendingManualHpStart=!1),Be&&(lo||Me(Ye))&&(o.commissioningTaskLock=""),$a&&(zu||Me(mo))&&(o.pendingHpWaterCalibrationStart=!1),go&&Me(mo)&&(o.commissioningTaskLock="");let iw=a?"Wachten op CM100":t,sw=a?"Service-stand wordt geopend. Wacht tot CM100 klaar staat.":i?"CM100 is actief en klaar voor service-taken.":"Start de service-stand voordat je een taak uitvoert.",lw=[{key:"hp-water-calibration",title:"Temperatuursensoren kalibreren",label:"Sensor kalibratie",summary:"Laat de waterpomp draaien zonder compressor en bepaal offsets voor HP1/HP2 water in/out.",status:Xu,available:!!(Uu||o.entities.hpWaterCalibrationStatus),openDisabled:!i,cardMarkup:en({taskKey:"hp-water-calibration",title:"Temperatuursensoren kalibreren",copy:"Doorloop voorbereiding, meting en toepassen in vaste volgorde. De meting stopt eerder zodra de sensoren stabiel genoeg zijn.",subcopy:"De voorgestelde waarden worden pas actief wanneer je ze toepast; supply blijft een diagnosewaarde.",status:Xu,statusCopy:Je?"De pomp draait en de firmware wacht op een stabiel temperatuurbeeld.":Aa?"Controleer de voorgestelde offsets voordat je ze toepast.":i?"CM100 staat klaar. Start de meting wanneer compressor en boiler uit zijn.":"Start CM100 eerst.",progressTask:"hp-water-calibration",controls:US({status:mo,running:Je,resultReady:Aa,startDisabled:rw,abortDisabled:nw,applyDisabled:aw,busy:Ma,controlsAvailable:!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort)}),className:"oq-settings-commissioning-card--hp-water-calibration"})},{key:"manual-flow",title:"Handmatige flowregeling",label:"Handmatige flow",summary:"Laat de waterpomp draaien op een tijdelijk flow-setpoint en luister naar het leidingwerk.",status:Ju,available:!!(ge||o.entities.manualFlowStatus),openDisabled:!i,cardMarkup:en({taskKey:"manual-flow",title:"Handmatige flowregeling",copy:"Gebruik een tijdelijk flow-setpoint om het leidingwerk rustig te controleren. De normale instellingen wijzigen pas wanneer je een waarde bewust overneemt.",subcopy:"De bestaande PI-regeling blijft de pomp aansturen.",status:Ju,statusCopy:he?"De waterpomp draait. Pas het tijdelijke setpoint aan en controleer de gemeten flow.":i?"CM100 staat klaar. Kies een tijdelijk setpoint en start de waterpomp.":"Start CM100 eerst.",progressTask:"",controls:`
            <div class="oq-settings-manual-flow-control">
              ...
              ${o.entities.manualFlowStart||o.entities.manualFlowAbort?lr({active:he,startKey:"manualFlowStart",stopKey:"manualFlowAbort",startLabel:"Waterpomp starten",stopLabel:"Waterpomp stoppen",startDisabled:ae||Xb,stopDisabled:ae||ew}):""}
            </div>
          `,metrics:`
        ...
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:Zu,available:!!(co||o.entities.manualHpStatus),openDisabled:!i,cardMarkup:en({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:Zu,statusCopy:$e?Ke?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":Sn?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
            ${o.entities.manualHpStart||o.entities.manualHpAbort?lr({active:$e,startKey:"manualHpStart",stopKey:"manualHpAbort",startLabel:"Bediening starten",stopLabel:"Bediening stoppen",startDisabled:De||tw,stopDisabled:De||ow}):""}
          `,controls:`
          ...
          `})},{key:"autotune",title:"Flow autotune",label:"Autotune",summary:"Berekent een voorstel voor de flowregeling en kan Kp/Ki daarna toepassen.",status:ks,available:!0,openDisabled:br(ks),cardMarkup:en({taskKey:"autotune",title:"Flow autotune",copy:"Bereken een voorstel voor de flowregeling en pas dat daarna toe in de installatie-instellingen. Autotune duurt meestal ongeveer 5 tot 10 minuten.",subcopy:"Na toepassen worden de flow-instellingen bijgewerkt.",status:ks,statusCopy:J?"Wacht totdat CM100 actief is voordat je autotune start.":V?"Autotune draait op dit moment.":i?"CM100 staat klaar. Start de autotune wanneer je wilt.":"Start CM100 eerst en voer daarna autotune uit.",progressTask:"autotune",actions:`
            ${o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort?lr({active:V,startKey:"flowAutotuneStart",stopKey:"flowAutotuneAbort",startLabel:"Autotune starten",stopLabel:"Autotune stoppen",startDisabled:x||td,stopDisabled:x||Qb}):""}
          ...
          `})},{key:"boiler",title:"Boiler power test",label:"Boiler test",summary:"Meet het effectieve boilervermogen bij stabiele flow en kan het resultaat toepassen.",status:qs,available:e,openDisabled:br(qs),cardMarkup:en({taskKey:"boiler",title:"Boiler power test",copy:"Meet het effectieve boilervermogen bij stabiele flow en schrijf daarna een afgerond voorstel weg naar de boilerinstelling. Boilertest duurt meestal ongeveer 5 tot 10 minuten.",subcopy:`Ingesteld boilervermogen: ${s(M)}`,status:qs,statusCopy:q?"Wacht totdat CM100 actief is voordat je de boiler-test start.":k?"De boiler-test draait op dit moment.":i?"CM100 staat klaar. Start de boiler-test wanneer je wilt.":"Start CM100 eerst en voer daarna de boilervermogentest uit.",progressTask:"boiler",actions:`
            ${o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort?lr({active:k,startKey:"boilerPowerTestStart",stopKey:"boilerPowerTestAbort",startLabel:"Boiler test starten",stopLabel:"Boiler test stoppen",startDisabled:g||ed,stopDisabled:g||Ub}):""}
          ...
          `})},{key:"purge",title:"Ontluchten",label:"Ontluchten",summary:"Draait een vaste ontluchtingsrun van 5 minuten met rustige flow, pomp-pulsen en stabilisatie.",status:Ts,available:$r,openDisabled:br(Ts),cardMarkup:en({taskKey:"purge",title:"Ontluchten",copy:"Draait 5 minuten met rustige doorstroming, korte pomp-pulsen en een stabilisatiefase.",subcopy:"Na afloop kan OpenQuatt de service mode (CM100) afsluiten of actief laten.",status:Ts,statusCopy:pe?"Ontluchten loopt vast 5 minuten door en stopt daarna automatisch.":i?"CM100 staat klaar. Start ontluchten wanneer het circuit open staat.":"Start CM100 eerst en voer daarna ontluchten uit.",progressTask:"purge",className:"oq-settings-commissioning-card--air-purge",actions:`
            ${o.entities.airPurgeStart||o.entities.airPurgeAbort?lr({active:pe,startKey:"airPurgeStart",stopKey:"airPurgeAbort",startLabel:"Ontluchten starten",stopLabel:"Ontluchten stoppen",startDisabled:ft||Jb,stopDisabled:ft||Zb}):""}
          `,metrics:`
...
Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return e("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Jt(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,No(),o.appView==="results"&&yr({force:!0}).then(()=>h())})},"select-energy-history-import-file":()=>xq(),"clear-energy-history-import-file":()=>{kg(),h()},"import-energy-history-file":()=>Mq(),"export-energy-history":()=>mq(),"open-history-storage-modal":()=>{o.settingsStoragePage="overview",o.systemModal="history-storage",h();let e=Ii({forceMissing:!0,forceTrendHistory:!0,forceDecisionLog:!0,forceEnergyHistory:!0}).finally(()=>{o.systemModal==="history-storage"&&h()});return No([1e3,3e3,7e3]),e},"open-storage-diagnosis":()=>{o.settingsStoragePage="diagnosis",h()},"open-storage-decision-log":()=>{o.settingsStoragePage="decision-log",h()},"open-storage-energy":()=>{o.settingsStoragePage="energy",h()},"back-storage-overview":()=>{o.settingsStoragePage="overview",h()},"download-settings-backup":()=>Pq(),"open-settings-backup-import":()=>{o.settingsBackupMqttPassword="",o.settingsBackupRestoreResult=null,o.settingsBackupError="",o.systemModal="settings-backup-import",h()},"confirm-settings-backup-restore":()=>Fq()};function Pg(e,t){return le(Wq,e,t)}function Ec(e,t,r="",n=!1){return`
    ...
    `}function jq(e,t,r,n=""){if(!y(e))return"";let a=o.entities[e],i=Array.isArray(a?.option)?a.option:[],l=String(E(e)||"");return i.length?`
    ...
    `}function Bq(){return o.trendHistoryMetadata&&typeof o.trendHistoryMetadata=="object"?o.trendHistoryMetadata:{}}function ln(){return!!o.trendHistoryMetadataSignature}function cn(){return!!(o.energyHistoryRaw||o.energyHistorySignature)}function dt(e){return e?"Niet geladen":"Laden..."}function je(e,t="\u2014"){if(y(e))return Ee(e);let r=Kq(e);return r==null||r===""?t:r}function Kq(e){let t=Bq();if(e==="trendHistoryFlashAvailable")return ln()?t.available||"Alleen live":dt(o.trendHistoryMetadataError);if(e==="trendHistoryFlashOldest")return ln()?t.oldest||"Geen data":dt(o.trendHistoryMetadataError);if(e==="trendHistoryFlashNewest")return ln()?t.newest||"Geen data":dt(o.trendHistoryMetadataError);if(e==="trendHistoryFlashLastFlush")return ln()?t.lastFlush||"Geen data":dt(o.trendHistoryMetadataError);if(e==="trendHistoryFlashSize")return ln()?Vi(t.sizeKb):dt(o.trendHistoryMetadataError);if(e==="trendHistoryFlashWrites")return ln()?ua(t.writes):dt(o.trendHistoryMetadataError);let r=Wg(),a=String(o.energyHistoryRaw||"").includes("@day_retention|");return e==="lifetimeEnergyHistoryAvailable"?cn()?a&&!r.dayPartitionAvailable?"Niet beschikbaar":Lg(r.storedDayCount,"Geen data"):dt(o.energyHistoryError):e==="lifetimeEnergyHistoryOldest"?cn()?_g(r.oldestDateKey):dt(o.energyHistoryError):e==="lifetimeEnergyHistoryNewest"?cn()?_g(r.newestDateKey):dt(o.energyHistoryError):e==="lifetimeEnergyHistoryLastWrite"?cn()?ji(r.dayLastWriteTimestampS):dt(o.energyHistoryError):e==="lifetimeEnergyHistorySize"?cn()?Vi(r.dayStorageKb):dt(o.energyHistoryError):e==="lifetimeEnergyHistoryWrites"?cn()?ua(r.dayWriteCount):dt(o.energyHistoryError):null}function Lg(e,t="Geen data"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:`${Math.round(r)} ${Math.round(r)===1?"dag":"dagen"}`}function Ig(e,t="Nog geen historie"){let r=Math.max(0,Math.round(Number(e)||0));return r<=0?t:`${r} ${r===1?"gebeurtenis":"gebeurtenissen"}`}function Fg(){return o.decisionLogStorageMetadata&&typeof o.decisionLogStorageMetadata=="object"?o.decisionLogStorageMetadata:{}}function Vi(e,t="\u2014"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:`${Math.round(r)} kB`}function ua(e,t="0"){let r=Number(e);return!Number.isFinite(r)||r<=0?t:String(Math.round(r))}function _g(e){let t=ie(e);return t?t.date.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit",year:"numeric"}):"Geen data"}function ji(e,t="Geen data"){let r=Number(e);if(!Number.isFinite(r)||r<=0)return t;let n=new Date(r*1e3),a=n.toLocaleDateString("nl-NL",{day:"2-digit",month:"2-digit"}),i=n.toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"});return`${a} ${i}`}function Wg(){return Ai(o.energyHistoryRaw)}function zq(e){let t=Array.isArray(e.items)?e.items:[];return`
    ...
    `}fp({getSignature:Bi,patch:Jq});function ef(){if(o.systemModal==="login")return Ym();if(o.systemModal==="api-security")return Qm();if(o.systemModal==="mqtt")return Rp();if(o.systemModal==="mqtt-sensors")return Hp();if(o.systemModal==="connectivity"){let e=Yq();return ee({modalId:"system",titleId:"oq-system-modal-title",kicker:"Systeem",title:"Connectiviteit",closeAction:"close-system-modal",closeLabel:"Sluit systeem-popup",bodyMarkup:`
      ...
      `:"";return ee({modalId:"system",titleId:"oq-backup-success-modal-title",kicker:"Beheer",title:"Backup hersteld",closeAction:"close-system-modal",closeLabel:"Sluit bevestiging",className:"oq-helper-modal--wide oq-helper-modal--scrollable",bodyMarkup:`
        ...
        `});if(o.systemModal==="webserver-logs")return Sm();if(o.systemModal==="debug-recording")return jm();if(o.systemModal==="openquatt-pause"){let e=C("openquattEnabled"),t=o.busyAction==="openquatt-regulation",r=y("openquattResumeAt"),n=o.loadingEntities||o.entitySyncInFlight,a=r||!n,i=Hn(),l=Pr(E("openquattResumeAt")),c=za();return ee({modalId:"system",titleId:"oq-openquatt-pause-modal-title",kicker:"Bediening",title:"Openquatt regeling",modalClass:"oq-helper-modal--wide",closeAction:"close-system-modal",closeLabel:"Sluit regeling-popup",bodyMarkup:`
      ...
      <div class="oq-settings-odu-runtime-table" role="table" aria-label="${s(`HP${e} ODU runtime frequentietabel`)}">
        ...
        ${Rr.map(r=>`
          <div class="oq-settings-odu-runtime-row" role="row">
            ...
            <div role="cell">${af(Wo(e,"cooling",r),r)}</div>
            <div role="cell">${af(Wo(e,"heating",r),t+r)}</div>
          </div>
        `).join("")}
      </div>
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(E("hpGeneration")||""),n=_t(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function pf(){let e=Pt(),t=o.entities.hpGeneration||{},r=y("hpGeneration")&&_t(t).length>0;return!e&&!r?"":re("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function Fc(e="oq-settings-grid oq-settings-boiler-simple-grid"){if(!y("boilerCvAssistEnabled"))return"";let t=C("boilerCvAssistEnabled"),r=y("boilerRatedHeatPower"),n=ze("boilerRatedHeatPower"),a=He("boilerRatedHeatPower"),i=o.loadingEntities||o.busyAction==="switch-boilerCvAssistEnabled",l=y("boilerConnection"),c=l?String(E("boilerConnection")||"R1"):"R1",d=rf({linkEntityPresent:y("otbLinkAvailable"),linkEntityConfirmedMissing:!!o.optionalMissingEntities?.otbLinkAvailable}),u=d===Po.SUPPORTED,m=d!==Po.UNKNOWN,w=c==="R1"&&C("otbConnectionMismatch"),v=l?nf(_t(o.entities.boilerConnection||{}),d):[],f=l&&m?`
    ...
    `:"",p=r?Eo({key:"boilerRatedHeatPower",value:a,meta:n,controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-boiler-power-control",unitMarkup:'<span class="oq-helper-unit-chip">W</span>'}):`
      ...
      `)}function ff(){let e=Ro(),t=li(),r=o.busyAction==="restartAction";return re("Diagnostiek","Systeemstatus","Snelle statusinformatie voor support, controle en onderhoud.",`
...
`)}function sT(e,t=""){if(!e.length)return`
    ...
    `}function tu(e,t,r,n){return`${r?gT(n):""}${mT(e,t)}`}function th(e,t,r,n,a){if(!e)return;let i=qe({mode:t,running:r,warningActive:n,failureText:a});e.dataset.renderSignature!==i&&(jt(e,tu(t,r,n,a)),e.dataset.renderSignature=i)}function rs(e,t,r=""){return`
    ...
    `}function jT(){let e=no(),t=Sc();return`
    ...
    `}function cE(e,t){if(!e)return!1;let r=e.querySelector(".oq-overview-hp-tools-copy"),n=e.querySelector('[data-hp-visual="schematic"]'),a=e.querySelector('[data-hp-visual="compact"]');return!r||!n||!a?(jt(e,yh(t)),!0):(jt(r,`
      <h3>Warmtepompen</h3>
      ${hh(t)}
    ...
    `}function t1(){let e=gt(),t=Ea(),r=CE(),n=Lo().filter(m=>!m.quick&&!m.custom),a=xE(),i=ME(a),l=xh(a.start),c=xh(a.end),d=o.controlReplayPeriodMenuOpen,u=e==="custom"?"Eigen periode":r.some(m=>m.id===e)?"Kies periode":t.shortLabel;return`
    ...
    `}function w1(){let e=typeof document<"u"?document.activeElement:null;return!e||typeof e.matches!="function"?null:e.matches("select[data-oq-dev-control]")?e:null}function v1(e){if(!e||o.deferDevControlSelectRender)return;o.deferDevControlSelectRender=!0;let t=()=>{e.removeEventListener("blur",t),e.removeEventListener("change",t),o.deferDevControlSelectRender=!1,window.setTimeout(()=>Xh(),0)};e.addEventListener("blur",t,{once:!0}),e.addEventListener("change",t,{once:!0})}function y1(){if(o.nativeOpen||o.appView!=="settings"||o.renderedAppView!=="settings"||o.renderedSettingsGroup!==o.settingsGroup)return null;let e=document.scrollingElement||document.documentElement,t=Number(window.scrollY||e?.scrollTop||0);return!Number.isFinite(t)||t<=0?null:{group:o.settingsGroup,left:Number(window.scrollX||e?.scrollLeft||0),top:t}}function S1(e){if(!e)return;let t=(o.settingsPageScrollRestoreToken||0)+1;o.settingsPageScrollRestoreToken=t;let r=()=>{if(t!==o.settingsPageScrollRestoreToken||o.nativeOpen||o.appView!=="settings"||o.settingsGroup!==e.group)return;let n=document.scrollingElement||document.documentElement;if(!n)return;let a=Math.max(0,n.scrollHeight-n.clientHeight),i=Math.min(e.top,a);window.scrollTo({left:e.left,top:i,behavior:"auto"})};window.requestAnimationFrame(()=>{r(),window.requestAnimationFrame(r),window.setTimeout(r,80)})}function Xh(){if(!o.root)return;let e=w1();if(e){v1(e);return}let t=p1(),r=Vd(o.root),n=o.systemModal==="webserver-logs"?eo():null,a=o.systemModal==="cm100-commissioning"?pm():null,i=String(o.systemModal||"").startsWith("service-task-")?gm():null,l=o.systemModal==="history-storage"?hm():null,c=o.systemModal==="settings-backup-restore"?wm():null,d=o.quickStartModalOpen?Tf():null,u=y1();if(o.nativeOpen){o.root.innerHTML=`
        ${$c()}
        ${Xg()}
      `,Ys(o.root),Zs(o.root,r),o.renderedAppView="native",o.renderedSettingsGroup="",o.settingsRenderSignature="",o.headerRenderSignature=Bi(),Lr({mqttSensorsModalRenderSignature:""}),_n(),Xn(),Jl(),Ks(),Bs(),to(n),Ul(a),Gl(i),Ql(l),Yl(c),jc(d);return}let m=h1(),w=o.loadingEntities?`${m}${f1()}`:m,v=o.appView==="overview"||o.appView==="control"||o.appView==="energy"||o.appView==="diagnosis"||o.appView==="results";o.root.innerHTML=`
      ${$c()}
