...
`)),r.toString()}function Hl(e,t){let r=[],n=[],a=[],i="";return e.forEach(l=>{let c=Fy(l);if(!c)return;let u=[...a,c],d=Op(u,t);if(a.length&&d.length>Ay){r.push({keys:n,body:i}),n=[l],a=[c],i=Op(a,t);return}n=[...n,l],a=u,i=d}),a.length&&r.push({keys:n,body:i}),r}async function Wy(e){let t=Rl(),r={method:"POST",cache:"no-store",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:e.body},n=await Hn(My,r,t,`bulk entities request timed out after ${t}ms`);if(!n.ok)throw new Error(`bulk entities HTTP ${n.status}`);return n.json()}async function jy(){let e=Rl(),r=await Hn(Ry,{cache:"no-store",headers:{"Cache-Control":"no-store"}},e,`service status request timed out after ${e}ms`);if(!r.ok)throw new Error(`service status HTTP ${r.status}`);return r.json()}async function Vy(){let e=Rl(),r=await Hn(Hy,{cache:"no-store",headers:{"Cache-Control":"no-store"}},e,`decision log request timed out after ${e}ms`);if(!r.ok)throw new Error(`decision log HTTP ${r.status}`);return r.json()}function By(e={}){let t=Array.isArray(e.events)?e.events:[],r=Array.isArray(e.buckets)?e.buckets:[],n=t[0]||{},a=t[t.length-1]||{},i=r[r.length-1]||{};return[e?.meta?.event_count??t.length,e?.meta?.dropped_count??0,t.length,n.seq??"",a.seq??"",a.uptime_s??"",e?.meta?.boot_epoch_s??"",n.epoch_s??"",a.epoch_s??"",r.length,i.hour_start_uptime_s??"",i.hour_start_epoch_s??"",i.source??"",i.attention_count??"",e?.meta?.flash_write_count??""].join("|")}async function Ky(e={}){if(o.appView!=="control")return!1;let t=e.force===!0,r=Date.now();if(!t&&o.decisionLogFetchPromise)return o.decisionLogFetchPromise;if(!t&&(o.decisionLog||o.decisionLogError)&&r-Number(o.decisionLogLastFetchAt||0)<_y)return!1;o.decisionLogFetchPromise=(async()=>{let n=await Vy(),a=Array.isArray(n?.events)?n.events:[];if(!n?.ok||!Array.isArray(n?.events))throw new Error("decision log response mist events");let i=By(n),l=o.decisionLogError!==""||o.decisionLogSignature!==i||!o.decisionLog;return o.decisionLog={...n,events:a,buckets:Array.isArray(n.buckets)?n.buckets:[]},o.decisionLogError="",o.decisionLogSignature=i,o.decisionLogLastFetchAt=Date.now(),l})();try{return await o.decisionLogFetchPromise}catch(n){let a=n.message||String(n),i=!!o.decisionLog||o.decisionLogError!==a;return o.decisionLog=null,o.decisionLogError=a,o.decisionLogSignature="",o.decisionLogLastFetchAt=Date.now(),i}finally{o.decisionLogFetchPromise=null}}function zy(e={}){let t=e?.entities&&typeof e.entities=="object"?e.entities:{};Object.entries(t).forEach(([r,n])=>{Cn.has(r)&&(o.optionalMissingEntities&&delete o.optionalMissingEntities[r],o.entities[r]=Gp(r,o.entities[r],n))})}async function Uy(e){if(!e.length)return{ok:!0,message:""};try{let t=await jy();return zy(t),o.lastEntityResponseAt=Date.now(),{ok:!0,message:""}}catch(t){return{ok:!1,message:t.message||String(t)}}}async function K(e,t="state",r={}){let n=Date.now(),a=r.forceMissing===!0,i=e.filter(b=>a||Cn.has(b)||!Ly(b,n));if(!i.length)return;let l=i.filter(b=>Cn.has(b)),c=i.filter(b=>!Cn.has(b)),d=(await Uy(l)).ok?c:[...c,...l];if(!d.length){Lp(),Wn(Zt()),o.busyAction||(Np(),o.controlError="");return}let m=Number(r.concurrency),w=Number.isFinite(m)&&m>0?Math.floor(m):zt,y=Hl(d,t),h=Math.max(1,Math.min(w,zt)),g=[];for(let b=0;b<y.length;b+=h){let S=y.slice(b,b+h),q=await Promise.allSettled(S.map(async T=>({chunk:T,payload:await Wy(T)})));g.push(...q)}g.some(b=>b.status==="fulfilled")&&(o.lastEntityResponseAt=Date.now());let p="";g.forEach(b=>{if(b.status!=="fulfilled"){let M=b.reason.message||String(b.reason);p||(p=M);return}let{chunk:S,payload:q}=b.value,T=q?.entities&&typeof q.entities=="object"?q.entities:{},k=new Set(Array.isArray(q?.missing)?q.missing:[]);S.keys.forEach(M=>{if(Object.prototype.hasOwnProperty.call(T,M)){o.optionalMissingEntities&&delete o.optionalMissingEntities[M],o.entities[M]=Gp(M,o.entities[M],T[M]);return}let R=L[M];R?.optional?k.has(M)&&Iy(M,n):p||(p=`${R?.name||M} ontbreekt in bulk response`)})}),Lp(),Wn(Zt()),p?(Up(p),o.deviceReconnectMode?o.controlError="":o.controlError=`Niet alle helpervelden konden worden ververst. ${p}`):o.busyAction||(Np(),o.controlError="")}function Gp(e,t={},r={}){let n={...t||{},...r||{}};return L[e]?.domain==="select"&&(!String(r.state??"").trim()&&String(t?.state??"").trim()&&(n.state=t.state),!String(r.value??"").trim()&&String(t?.value??"").trim()&&(n.value=t.value),!Array.isArray(r.option)&&Array.isArray(t?.option)&&(n.option=t.option),!Array.isArray(r.options)&&Array.isArray(t?.options)&&(n.options=t.options)),n}function Lp(){o.complete=za(),o.stage=o.complete===!0?"Gereed":o.complete===!1?"Quick Start":"Laden...",o.summary=qd(),o.appView==="diagnosis"&&!bt()&&_t(vo(),{syncMode:"replace",forceSync:!0}),o.appView||_t(In()||vo(),{syncMode:"replace",forceSync:!0})}function Gy(){let e=Cl();return o.appView==="settings"?[...new Set([...e,...xl()])]:o.appView==="energy"||o.appView==="results"?jn(o.appView,{forceFast:!0}):o.appView==="overview"||o.appView==="diagnosis"?jn(o.appView,{forceFast:!0}):[...new Set(e)]}function Qy(e=[]){let t=new Set(e);return(o.appView==="settings"?xl():o.appView==="overview"||o.appView==="control"||o.appView==="diagnosis"?[...new Set([...jn(o.appView,{includeBulk:!0}),...Gt])]:o.appView==="energy"||o.appView==="results"?[...new Set([...jn(o.appView,{forceFast:!0}),...Gt])]:[...new Set(["setupComplete","strategy",...at])]).filter(n=>!t.has(n))}function Ip(e=Date.now(),t={}){return t.forceBulk===!0?!0:e-Number(o.lastBulkEntitySyncAt||0)>=nd}async function qe(e={}){if(o.nativeOpen||o.loadingEntities||o.draggingCurveKey||o.busyAction||o.settingsInteractionLock)return;if(o.updateInstallBusy||Xa()){o.pendingEntitySyncOptions=null;return}if(o.focusedField&&o.appView!=="settings")return;if(o.entitySyncInFlight){ky(e);return}let t=Date.now();if(document.hidden&&t-Number(o.lastEntitySyncAttemptAt||0)<Mn)return;let r=o.appView,n=e.prefetchView==="overview"&&!e.forceBulk&&r==="settings",a=n?"overview":r,i=a==="overview"||a==="control"||a==="diagnosis"||a==="energy"||a==="results",l=e.forceFast===!0&&!e.forceBulk,c=!l&&!n&&Ip(t,e),d=t-Number(o.lastStaticEntitySyncAt||0)>=ad||o.updateInstallBusy||o.updateInstallPhaseHint?Gt:[],m=o.quickStartModalOpen&&o.currentStep==="flow-source"?ht:[],w=o.quickStartModalOpen&&o.currentStep==="setup"?$t:[],y=o.quickStartModalOpen&&o.currentStep==="thermostat-source"?Wo:[],h=fl()?Xt():[],g=n?[...Hs,...at,"setupComplete",...d]:i?[...jn(a,{forceFast:l,includeBulk:c}),...d]:r==="settings"?[...new Set([...xl(),...h,...d])]:c?["setupComplete",...d,...at,"strategy",...Io,...nt,...ie()?ye.map(p=>p.key):xt]:["setupComplete",...at,"strategy",...d];o.entitySyncInFlight=!0,o.lastEntitySyncAttemptAt=t;try{let p=o.deviceReconnectMode,b=Ny(t,e)?await Oy():{ok:!0,message:""};if(!b.ok){Up(b.message),n||f();return}if(await K([...new Set([...g,...o.ota.wait?["uptime","projectVersionText"]:[],...w,...m,...y])],n?"state":r==="settings"||w.length?"all":"state",{concurrency:l&&i?Ut:zt}),o.lastFastEntitySyncAt=Date.now(),c&&(a==="overview"||a==="control"||a==="diagnosis")&&!n&&(o.lastBulkEntitySyncAt=o.lastFastEntitySyncAt),d.length&&(o.lastStaticEntitySyncAt=o.lastFastEntitySyncAt),n)return;i&&!o.overviewMetadataHydrated&&!o.overviewMetadataHydrating&&Wp();let S=p!==o.deviceReconnectMode,q=l&&i,T=q?!1:a==="overview"||a==="control"||a==="diagnosis"?await hl():!1,k=q?!1:o.appView==="results"?await ti():!1,M=a==="control"?await Ky({force:e.forceDecisionLog===!0}):!1,R=q?!1:fl()?(await Promise.all([fp(),ti({metaOnly:!0})])).some(Boolean):!1,_=q||!Ld()?!1:await Qo(),W=q||!Id()?!1:await Yo(),I=q||!Ap()?!1:await er({force:o.systemModal==="mqtt-sensors"}),j=dp();if(q&&!o.nativeOpen&&Kp($l(a)),S){f();return}if(T&&o.appView==="diagnosis"&&!o.root?.querySelector(".oq-overview-trends")){f();return}if(k&&o.appView==="results"&&!o.root?.querySelector(".oq-energy-history")){f();return}if(M&&o.appView==="control"){bl()||f();return}if(R&&o.appView==="settings"){f();return}if(_&&(o.systemModal==="login"||Yt())){f();return}if(W&&o.appView==="settings"){f();return}if(o.systemModal==="mqtt-sensors"){ri()!==o.mqttSensorsModalRenderSignature&&f();return}if(I&&o.appView==="settings"){f();return}let x=!!(o.updateModalOpen||o.systemModal||o.interfacePanelOpen);if(j!==o.headerRenderSignature)if(x&&dl())o.headerRenderSignature=j;else{f();return}else dl();if(o.appView==="settings"&&String(o.systemModal||"").startsWith("service-task-")){Pn()!==o.settingsRenderSignature&&f();return}if(x)return;if(o.appView==="settings"){let P=Pn();if(P!==o.settingsRenderSignature&&!o.focusedField){f();return}if(!mp()){o.focusedField||f();return}o.focusedField&&(o.settingsRenderSignature=P);return}if(o.appView==="diagnosis"){vp()||f();return}if(o.appView==="control"){bl()||f();return}if(o.appView==="energy"){bp()||f();return}if(o.appView==="results"){wp()||f();return}yp()||f()}catch(p){n||(o.controlError=`Helperstatus kon niet worden geladen. ${p.message}`,f())}finally{o.entitySyncInFlight=!1;let p=o.pendingEntitySyncOptions;o.pendingEntitySyncOptions=null,p&&!o.nativeOpen&&window.setTimeout(()=>{qe(p)},0),l&&(a==="overview"||a==="control"||a==="diagnosis")&&!n&&!o.nativeOpen&&!p&&Ip(Date.now())&&window.setTimeout(()=>{qe({forceBulk:!0})},Sy)}}function Pt(){return{}}function Yy(){let e=String(E("hpGeneration")||"").trim();return e||""}function or(e){let t=String(e||"").trim().toLowerCase();return t==="single"||t.includes("quatt single")||t.includes("openquatt single")?"single":t==="duo"||t.includes("quatt duo")||t.includes("openquatt duo")?"duo":""}function Jy(){if(!Array.isArray(Hr))return"";if(Hr.some(t=>v(t)))return"duo";let e=o.optionalMissingEntities||{};return Hr.every(t=>e[t])?"single":""}function _l(e){let t=or(e);return(t==="single"||t==="duo")&&typeof o<"u"&&o&&typeof o=="object"&&(o.lastKnownInstallationTopology=t),t}function Zy(){if(typeof o<"u"&&o&&typeof o=="object"){let e=String(o.lastKnownInstallationTopology||"").trim().toLowerCase();if(e==="single"||e==="duo")return e}return""}function oe(){let e=or(E("installationTopology"));if(e==="single"||e==="duo")return _l(e);let t=or(Pt().installation);if(t==="single"||t==="duo")return _l(t);let r=Jy();return r?_l(r):Zy()}function Nt(){let e=oe(),t=Yy();return e==="single"?t?`Quatt Single ${t}`:"Quatt Single":e==="duo"?t?`Quatt Duo ${t}`:"Quatt Duo":t?`Quatt Hybrid ${t}`:"Quatt Hybrid"}function et(){return"OpenQuatt"}function Vn(e){let t=String(e||"").trim().toLowerCase();return t==="wifi"||t==="wi-fi"||t.includes("wifi")||t.includes("wi-fi")?"wifi":t==="eth"||t==="ethernet"||t.includes("ethernet")?"eth":""}function st(e=lt()){return e==="wifi"?"Wi-Fi":e==="eth"?"Ethernet":"Onbekend"}function rr(e=oe()){return e==="single"?"Single":e==="duo"?"Duo":"Onbekende opstelling"}function Wr(){let e=String(E("hardwareProfileText")||"").trim().toLowerCase();return e&&e!=="unknown"&&e!=="onbekend"?e:String(Pt().hardwareProfile||e).trim().toLowerCase()}function lt(){return Vn(E("connectionText")||Pt().connection)}function Qp(){let e=lt();return e==="wifi"?"eth":e==="eth"?"wifi":""}function Yp(){let e=oe();return e==="single"?"duo":e==="duo"?"single":""}function ko(e=oe(),t=lt()){let r=rr(e),n=Wr();return n==="heatpump_controller_q"?`Heatpump Controller Q ${r} ${st(t)}`:n==="heatpump_listener"?`Heatpump Listener ${r} ${st(t)}`:n==="waveshare"?`Waveshare ${r} ${st(t)}`:`${et()} ${r} ${st(t)}`}function Dl(){let e=C("timeValid"),t=String(E("timeNowHhmm")||"").trim();if(t&&t!=="invalid")return t;if(v("timeValid")&&!e)return"Geen tijdsync";try{return new Intl.DateTimeFormat("nl-NL",{hour:"2-digit",minute:"2-digit"}).format(new Date)}catch{return new Date().toLocaleTimeString("nl-NL",{hour:"2-digit",minute:"2-digit"})}}function ai(){return v("timeValid")&&!C("timeValid")?"Geen tijdsync":`${new Intl.DateTimeFormat("nl-NL",{day:"numeric",month:"short",year:"numeric"}).format(new Date)} \xB7 ${Dl()}`}function Xy(e){return String(e?.uom??e?.unit_of_measurement??"").trim().toLowerCase()}function ev(e){let t=e?.state;if(t!==""&&t!==null&&t!==void 0){let a=Number(t);if(Number.isFinite(a))return a}let r=e?.value,n=Number(r);return Number.isFinite(n)?n:NaN}function jr(){let e=ev(o.entities.uptime);if(Number.isFinite(e)&&e>=0){let n=Xy(o.entities.uptime);if(n==="d")return Uo(e*1440);if(n==="h")return Uo(e*60);if(n==="s")return Uo(e/60)}let t=String(o.entities.uptimeReadable?.state??o.entities.uptimeReadable?.value??"").trim();if(t&&t.toLowerCase()!=="unknown")return t;let r=Number(Pt().bootedAt);return!Number.isFinite(r)||r<=0?"\u2014":Uo((Date.now()-r)/6e4)}function Vr(){let e=String(o.entities.ipAddress?.state??o.entities.ipAddress?.value??"").trim();if(e)return e;let t=String(Pt().ipAddress||"").trim();return t||(typeof window<"u"?String(window.location.hostname||"").trim():"")||"\u2014"}function To({getScroller:e,getToken:t,setToken:r,isActive:n=()=>!0,getIdentity:a=null,preserveGrowth:i=!1,stickToBottom:l=!1,nearBottomThreshold:c=48}){function u(){let y=e();if(!y)return null;let h={scrollTop:y.scrollTop};if((i||l)&&(h.scrollHeight=y.scrollHeight),l){let g=y.scrollHeight-y.scrollTop-y.clientHeight;h.stickToBottom=g<c}return a&&(h.identity=a(y)),h}function d(y){if(!y)return;let h=e();if(!h||a&&a(h)!==y.identity)return;if(y.stickToBottom){h.scrollTop=h.scrollHeight;return}let g=i?h.scrollHeight-Number(y.scrollHeight||0):0;h.scrollTop=Math.max(0,Number(y.scrollTop||0)+g)}function m(y,h=!0){if(!y)return;let g=Number(t()||0)+1;r(g);let p=()=>{Number(t()||0)!==g||!n()||d(y)};if(h){window.requestAnimationFrame(p);return}p()}function w(){r(Number(t()||0)+1)}return{capture:u,invalidate:w,queue:m,restore:d}}function Ae(e){return Object.prototype.hasOwnProperty.call(o.inputDrafts,e)?o.inputDrafts[e]:E(e)}function Eo({key:e,value:t,meta:r,controlClass:n,inputClass:a="oq-helper-input",inputAttributes:i="",unitMarkup:l=""}){return`
  ...
  `;if(!d)return y;let h=u||ke(t),g=m||`${e}-${t}`;return`
  ...
  `}function ir({active:e,startKey:t,stopKey:r,startLabel:n,stopLabel:a,startClass:i="oq-helper-button oq-helper-button--primary",stopClass:l="oq-helper-button oq-helper-button--ghost",startDisabled:c=!1,stopDisabled:u=!1}){return tt(e?r:t,e?a:n,e?l:i,e?u:c)}function Xp(e,t,r,n,a=""){if(!v(e))return"";let i=o.entities[e]||{},l=String(E(e)||""),c=Ot(i),u=o.loadingEntities||o.busyAction===`save-${e}`,d=`
    <div class="oq-settings-choice-grid">
      ${c.map(m=>{let w=n[m]||"",y=typeof w=="string"?w:w.copy||"",h=typeof w=="string"?"":w.image||"",g=typeof w=="string"?"":w.alt||"";return Br({key:e,option:m,currentValue:l,busy:u,copy:y,image:h,imageAlt:g})}).join("")}
    </div>
  `;return he(e,t,r,d,a)}function ue(e,t,r,n="",a={}){if(!v(e))return"";let i=ze(e),l=Ae(e),c=a.unitOverride||i.uom||"",u=a.showUnit!==!1&&!!c,d=u&&a.unitMode!=="outside",m=Eo({key:e,value:l,meta:i,controlClass:`oq-helper-control${u&&!d?" oq-helper-control--split":""}${d?" oq-helper-control--suffix":""}`,unitMarkup:u?d?`<span class="oq-helper-unit-chip">${s(c)}</span>`:`<span class="oq-helper-unit">${s(c)}</span>`:""});return he(e,t,r,m,n,a.footerMarkup||"")}function ct(e,t,r,n="",a={}){if(!v(e))return"";let i=ze(e),l=ve(e,E(e)),c=a.minLabel||`${i.min}${i.uom||""}`,u=a.maxLabel||`${i.max}${i.uom||""}`,d=a.valueLabel||Y(e,l);return he(e,t,r,`<label class="oq-helper-slider-field"><div class="oq-helper-slider-meta"><span>${s(c)}</span><strong>${s(d)}</strong><span>${s(u)}</span></div><input class="oq-helper-range" type="range" data-oq-field="${s(e)}" min="${i.min}" max="${i.max}" step="${i.step}" value="${l}" ${o.loadingEntities?"disabled":""}></label>`,n)}function Nl(e,t,r,n={}){if(!v(e))return"";let a=ze(e),i=Ae(e),l=n.compact===!0,c=n.embedded===!0,u=n.infoId||e,d=n.showCopy!==!1;return`
...
`)}async function Wv(){let e=Fv();if(o.webServerLogCopyMessage="",o.webServerLogCopyError="",!e){o.webServerLogCopyError="Er zijn nog geen logregels om te kopi\xEBren.",f();return}try{if(!await wo(e))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");o.webServerLogCopyMessage=`${o.webServerLogEntries.length} logregel${o.webServerLogEntries.length===1?"":"s"} gekopieerd.`}catch(t){o.webServerLogCopyError=t instanceof Error?t.message:"Kopi\xEBren naar het klembord is niet gelukt."}o.systemModal==="webserver-logs"&&f()}var jv={"open-webserver-log-modal":()=>qv(),"clear-webserver-log-output":()=>kv(),"copy-webserver-log-output":()=>Wv()};function gm(e){return se(jv,e)}function fm(){let e=lr(),t=o.busyAction==="clear-webserver-log-history",r=!!o.busyAction||o.webServerLogHistoryLoading||!e&&!o.nativeOpen&&!o.webServerLogCsrfToken;return te({id:"system",titleId:"oq-webserver-log-modal-title",kicker:"Diagnostiek",title:"OpenQuatt log",copy:e?"Hier zie je voorbeeldmeldingen uit de lokale preview.":"Hier zie je recente meldingen van OpenQuatt. Handig als je wilt terugzoeken wat er net gebeurde.",className:"oq-helper-modal--wide oq-helper-modal--scrollable oq-webserver-log-modal",closeAction:"close-system-modal",closeLabel:"Sluit logboek",body:`
    ...
    `})}function Vv(){let e=o.entities.firmwareUpdateTarget||{};return Array.isArray(e.option)?e.option:Array.isArray(e.options)?e.options:[]}function Gl(e){return Vv().includes(e)}function di(){let e=Wr(),t=oe(),r=lt(),n=Qp();return e!=="heatpump_controller_q"||t!=="single"&&t!=="duo"||r!=="wifi"&&r!=="eth"||!n?null:{canSwitch:v("firmwareUpdateTarget")&&Gl("alternate connection")&&v("installFirmwareUpdateTarget"),currentConnection:r,targetConnection:n,currentLabel:st(r),targetLabel:st(n),currentBuildLabel:ko(t,r),targetBuildLabel:ko(t,n)}}function pi(){let e=Wr(),t=oe(),r=Yp(),n=lt(),a=e==="heatpump_controller_q"?["wifi","eth"]:["wifi"];return!["heatpump_controller_q","heatpump_listener","waveshare"].includes(e)||t!=="single"&&t!=="duo"||!r||!a.includes(n)?null:{canSwitch:v("firmwareUpdateTarget")&&Gl("alternate topology")&&v("installFirmwareUpdateTarget"),currentTopology:t,targetTopology:r,currentConnection:n,targetConnection:n,currentLabel:rr(t),targetLabel:rr(r),currentBuildLabel:ko(t,n),targetBuildLabel:ko(r,n)}}function mi(e,t){let r=Wr(),n=oe(),a=lt(),i=or(e),l=Vn(t),c=i&&i!==n,u=l&&l!==a,d=c&&u?"alternate topology and connection":c?"alternate topology":u?"alternate connection":"current build",m=r==="heatpump_controller_q"&&["single","duo"].includes(n)&&["single","duo"].includes(i)&&["wifi","eth"].includes(a)&&["wifi","eth"].includes(l),w=v("firmwareUpdateTarget"),y=Gl(d),h=v("installFirmwareUpdateTarget");return{available:m,canSwitch:m&&d!=="current build"&&w&&y&&h,targetEntityAvailable:w,targetOptionAvailable:y,installActionAvailable:h,currentTopology:n,currentConnection:a,targetTopology:i,targetConnection:l,targetOption:d,currentBuildLabel:ko(n,a),targetBuildLabel:ko(i,l)}}function ur(e=o.updateTestFirmwarePr){let t=String(e||"").trim().replace(/^#?pr[-\s]*/i,"").replace(/^#/,"");return/^\d{1,6}$/.test(t)?t:""}function zr(){let e=Wr(),t=oe(),r=lt(),a={waveshare:{slug:"waveshare",label:"Waveshare",connections:["wifi"]},heatpump_listener:{slug:"heatpump-listener",label:"Heatpump Listener",connections:["wifi"]},heatpump_controller_q:{slug:"heatpump-controller-q",label:"Heatpump Controller Q",connections:["wifi","eth"]}}[e];if(!a||t!=="single"&&t!=="duo"||!a.connections.includes(r))return{available:!1,label:"Onbekend target",error:"Deze firmware meldt geen herkenbaar hardware-, opstelling- of verbindingsprofiel."};let i=`openquatt-${a.slug}-${t}-${r}`,l=t==="duo"?"Duo":"Single";return{available:!0,artifactName:i,otaFileName:`${i}.firmware.ota.bin`,md5FileName:`${i}.firmware.ota.bin.md5`,label:`${a.label} ${l} ${st(r)}`}}function Bn(e=ur(),t=zr()){if(!e||!t.available)return null;let n=`${`https://github.com/OpenQuatt/OpenQuatt/releases/download/pr-${e}`}/${t.otaFileName}`;return{otaUrl:n,md5Url:`${n}.md5`,releaseApiUrl:`https://api.github.com/repos/OpenQuatt/OpenQuatt/releases/tags/pr-${e}`}}function Ao(){if(ut())return"Controleren";let e=qt();if(e)return e.phaseLabel;if(Yl())return"Bijgewerkt";if(cr())return"Bezig";if(pr())return"Beschikbaar";let t=Sm();if(t!==null&&t<=0)return"Actueel";let r=Pt();return typeof r.updateLabel=="string"&&r.updateLabel.trim()?r.updateLabel.trim():r.updateAvailable===!0?"Beschikbaar":r.updateAvailable===!1||vm()?"Actueel":be()?"Nog niet gecontroleerd":"\u2014"}function be(){return o.entities.firmwareUpdate||null}function gi(){let e=be();return e?String(e.state??e.value??"").trim().toLowerCase():""}function Bv(){let e=o.entities.firmwareUpdateStatus;return e?String(e.state??e.value??"").trim():""}function Kn(){return Bv().toLowerCase()}function wm(){let e=o.entities.firmwareUpdateProgress;if(!e)return Number.NaN;let t=Number(e.value??e.state);return Number.isNaN(t)?Number.NaN:Math.max(0,Math.min(100,t))}function Ql(){let e=String(o.updateInstallTargetVersion||"").trim(),t=le();return!e||!t?!1:zn(t,e)>=0}function Kv(e=be()||{}){let t=ro(e),r=le(e);return!t||!r?!1:zn(r,t)>=0}function ym(){return(Ql()||Kv())&&!ut()&&!Kr()&&!pr()}function zv(){return o.updateInstallMode===""||o.updateInstallMode==="test-firmware"?!!(o.ota.id&&!o.ota.wait):!Kr()&&!cr()&&Ql()}function Yl(){return(o.updateInstallCompleted||ym())&&!ut()&&!qt()&&!pr()}function dr(){Me({updateInstallBusy:!1,updateInstallTargetVersion:"",updateInstallPhaseHint:"",updateInstallProgressHint:Number.NaN,updateInstallStatusPollObserved:!1,updateInstallMode:"",updateInstallTargetConnection:"",updateInstallTargetTopology:""}),eS()}function Lt(){o.updateInstallPhaseHint="starting",o.updateInstallProgressHint=0,o.updateInstallStatusPollObserved=!1}function Ee(){Me({updateManualUploadFile:null,updateManualUploadFileName:"",updateManualUploadError:""})}function ot(e={}){Me({...e.clearPr?{updateTestFirmwarePr:""}:{},updateTestFirmwareConfirmed:!1,updateTestFirmwareError:"",updateTestFirmwareBuild:null})}function Uv(){let e=Kn(),t=wm(),r=e!=="rebooting"||!o.updateInstallBusy||o.updateInstallStatusPollObserved;if((e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting")&&r){o.updateInstallPhaseHint=e,Number.isNaN(t)||(o.updateInstallProgressHint=e==="rebooting"?Math.max(t,100):t);return}if(o.updateInstallBusy){if(o.updateInstallMode==="normal"&&Ql()){o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100;return}o.controlNotice.includes("opnieuw is opgestart")&&(o.updateInstallPhaseHint="rebooting",o.updateInstallProgressHint=100)}}function Kr(){let e=Kn();return e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting"}function Gv(){let e=Kn();return e==="error"?"De firmware-installatie op het device is mislukt. Controleer de netwerkverbinding en probeer opnieuw.":e==="aborted"?"De firmware-installatie is door het device afgebroken. Probeer de installatie opnieuw.":""}function qt(){Uv();let e=Kn(),t=e==="starting"||e==="retrying"||e==="uploading"||e==="rebooting"&&(!o.updateInstallBusy||o.updateInstallStatusPollObserved),r=t?e:o.updateInstallPhaseHint,n=wm(),a=Number.isNaN(o.updateInstallProgressHint)?0:Math.round(o.updateInstallProgressHint),i=t&&!Number.isNaN(n)?Math.round(n):a;return!Kr()&&!o.updateInstallBusy?null:r==="rebooting"?{phaseLabel:"Herstarten",percent:Math.max(i,100),copy:o.updateInstallMode==="test-firmware"?"Testfirmware is geplaatst. Het device start opnieuw op en komt daarna vanzelf terug.":o.updateInstallMode==="connection-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna via de gekozen verbinding terug.":o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?"Firmware is geplaatst. Het device start opnieuw op en komt daarna met de gekozen opstelling terug.":"Firmware is geplaatst. Het device start nu opnieuw op en komt daarna vanzelf terug."}:r==="retrying"?{phaseLabel:"Opnieuw proberen",percent:0,copy:"De eerste verbinding voor de firmwaredownload mislukte. OpenQuatt probeert het automatisch nog \xE9\xE9n keer."}:r==="uploading"?{phaseLabel:"Uploaden",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware wordt nu door ${et()} gedownload en ge\xEFnstalleerd.`:o.updateInstallMode==="connection-switch"?`De ${st(o.updateInstallTargetConnection)}-build wordt nu naar ${et()} verzonden.`:o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?`De ${ko(o.updateInstallTargetTopology,o.updateInstallTargetConnection)}-build wordt nu naar ${et()} verzonden.`:`Firmware wordt nu naar ${et()} verzonden.`}:{phaseLabel:"Installeren",percent:i,copy:o.updateInstallMode==="test-firmware"?`Testfirmware-installatie is gestart voor ${et()}.`:o.updateInstallMode==="connection-switch"?`Verbindingswissel naar ${st(o.updateInstallTargetConnection)} is gestart.`:o.updateInstallMode==="topology-switch"||o.updateInstallMode==="build-switch"?`Opstellingswissel naar ${rr(o.updateInstallTargetTopology)} is gestart.`:`OTA-update is gestart voor ${et()}.`}}function ro(e=be()||{}){let t=String(e.latest_version||"").trim();if(t)return t;let r=String(e.value||"").trim(),n=String(e.current_version||"").trim();return r&&r!==n&&/^v/i.test(r)?r:""}function le(e=be()||{}){let t=String(o.entities.projectVersionText?.state||o.entities.projectVersionText?.value||"").trim();return t||String(e.current_version||"").trim()}function Qv(e=be()||{}){let t=le(e),r=String(e.current_version||"").trim();return!t||!r||t===r?!1:zn(t,r)>0}function Jl(e=be()||{},t=Mo()){let r=String(t||"").trim().toLowerCase(),n=String(e.release_url||"").trim().toLowerCase(),a=ro(e).toLowerCase();if(!r||r==="\u2014")return!0;if(r==="dev"){if(n){if(n.includes("/dev-latest"))return!0;if(a)return a.includes("-dev")}return a?a.includes("-dev"):!1}if(r==="main"){if(n){if(n.includes("/dev-latest"))return!1;if(a)return!a.includes("-dev")}return a?!a.includes("-dev"):!1}return!0}function hm(e){let r=String(e||"").trim().match(/^v?(\d+)\.(\d+)\.(\d+)(?:-([A-Za-z]+)(?:\.(\d+))?)?/);return r?{major:Number(r[1]),minor:Number(r[2]),patch:Number(r[3]),prereleaseTag:r[4]||"",prereleaseNumber:r[5]?Number(r[5]):null}:null}function zn(e,t){let r=hm(e),n=hm(t);if(!r||!n)return 0;if(r.major!==n.major)return r.major>n.major?1:-1;if(r.minor!==n.minor)return r.minor>n.minor?1:-1;if(r.patch!==n.patch)return r.patch>n.patch?1:-1;let a=!r.prereleaseTag,i=!n.prereleaseTag;return a!==i?a?1:-1:r.prereleaseTag!==n.prereleaseTag?r.prereleaseTag>n.prereleaseTag?1:-1:r.prereleaseNumber!==n.prereleaseNumber?(r.prereleaseNumber||0)>(n.prereleaseNumber||0)?1:-1:0}function cr(){if(ym())return!1;let e=gi();return o.updateInstallBusy||e==="installing"||e==="in_progress"||e==="updating"||e.includes("install")}function ut(){let e=gi();return o.updateCheckBusy||e==="checking"||e==="check"||e==="checking_for_update"||e.includes("checking")}function pr(){let e=gi();if(!Jl())return!1;let t=Sm();return t!==null?t>0:e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")?!1:e==="available"||e==="pending"||e.includes("available")?!0:Pt().updateAvailable===!0}function vm(){let e=gi();return e==="installed"||e==="current"||e==="up_to_date"||e==="none"||e.includes("up to date")||e.includes("no update")||Qv()}function Zl(){let e=be()||{},t=le(e)||"\u2014",r=Jl(e)?ro(e):"",n=r?zn(r,t):null;return!ut()&&n!==null&&n<=0&&(r=""),{current:t,latest:r||"\u2014"}}function Sm(){let{current:e,latest:t}=Zl();return e==="\u2014"||t==="\u2014"?null:zn(t,e)}function qm(e=Mo()){let t=String(e||"").trim().toLowerCase();return Ss[t]||Ss.main}function Yv(){let e=String((be()||{}).release_url||"").trim(),t=qm();return!e||t.includes("/dev-latest")&&!e.includes("/dev-latest")||!t.includes("/dev-latest")&&e.includes("/dev-latest")?t:e}function Jv(){return et()}function Mo(){return String(E("firmwareUpdateChannel")||o.entities.releaseChannelText?.state||o.entities.releaseChannelText?.value||"\u2014").trim()||"\u2014"}function Zv(){return Zl().latest!=="\u2014"}function bm(e){return String(e||"").toLowerCase().replace(/wi[\s-]?fi/g,"wifi").replace(/[^a-z0-9]+/g,"")}function Xv(e,t=be()||{}){let r=bm(e);return r?bm(`${t.title||""} ${t.summary||""}`).includes(r):!0}function km(e){return new Promise(t=>window.setTimeout(t,e))}function Ur(e=bo){let r=Date.now()+e;o.firmwareOtaQuietUntil=Math.max(Number(o.firmwareOtaQuietUntil||0),r),o.pendingEntitySyncOptions=null,Zd(),typeof St=="function"&&St(),o.firmwareOtaQuietTimer&&window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=window.setTimeout(()=>{o.firmwareOtaQuietTimer=null,o.firmwareOtaQuietUntil=0,!o.updateInstallBusy&&!o.nativeOpen&&Xs()},e)}function eS(){o.firmwareOtaQuietTimer&&(window.clearTimeout(o.firmwareOtaQuietTimer),o.firmwareOtaQuietTimer=null),o.firmwareOtaQuietUntil=0,o.nativeOpen||Xs()}function Tm(){return o.deviceReconnectMode?te({modalId:"reconnect",titleId:"oq-reconnect-modal-title",kicker:"Systeem",title:_d(),modalClass:"oq-helper-modal--reconnect",role:"status",ariaLive:"polite",bodyMarkup:`
      ...
      `}):""}function Un(e=Mo()){let t=be()||{},r=le(t);o.entities.firmwareUpdate={...t,state:"CHECKING",value:"",latest_version:"",latestVersion:"",summary:"",release_url:qm(e),current_version:r}}async function Gn(e={}){let t=String(e.expectedBuildLabel||"").trim();for(let r=0;r<6;r+=1){await km(r===0?900:1200),await K($t,"all",{forceMissing:!0});let n=Jl(),a=!t||Xv(t),i=Zv(),l=ut(),c=Ao();if(n&&a&&(i||!l&&c!=="Nog niet gecontroleerd"))return!0}return!1}async function mr(e={}){let t=!1,r=Number.isFinite(Number(e.initialDelayMs))?Math.max(0,Number(e.initialDelayMs)):700,n=Number.isFinite(Number(e.pollDelayMs))?Math.max(250,Number(e.pollDelayMs)):1e3;for(let a=0;a<45;a+=1){await km(a===0?r:n);try{let i=o.entities.firmwareUpdateStatus,l=o.ota.wait?[...$t,"uptime"]:$t;await K(l,"all",{forceMissing:!0});let c=Kn();o.entities.firmwareUpdateStatus!==i&&(o.updateInstallStatusPollObserved=!0);let u=Gv();if(u){let d=new Error(u);throw d.firmwareInstallTerminal=!0,d}if(c==="rebooting"&&o.updateInstallStatusPollObserved&&Ht("ota"),f(),o.updateInstallMode==="connection-switch"){let d=Vn(o.updateInstallTargetConnection);if(d&&lt()===d&&!Kr()&&!cr())return Lr(),!0}else if(o.updateInstallMode==="topology-switch"){let d=or(o.updateInstallTargetTopology);if(d&&oe()===d&&!Kr()&&!cr())return Lr(),!0}else if(o.updateInstallMode==="build-switch"){let d=or(o.updateInstallTargetTopology),m=Vn(o.updateInstallTargetConnection);if(d&&m&&oe()===d&&lt()===m&&!Kr()&&!cr())return Lr(),!0}else if(zv())return Lr(),!0}catch(i){if(i?.firmwareInstallTerminal)throw Go(),i;t||(o.controlNotice="Wachten tot het device opnieuw is opgestart...",f(),t=!0)}}return Or(),!1}function tS(){let e=Mo(),t=qt();if(t)return t.copy;if(Yl()){let r=o.updateInstallCompletedVersion||le()||Mo();return`${et()} draait nu op ${r}.`}return cr()?`OTA-update wordt voorbereid voor ${et()}. Het device kan kort herstarten.`:ut()?`We controleren of er op kanaal ${e} een nieuwe firmware beschikbaar is.`:pr()?"Er staat een nieuwere firmware klaar.":vm()?`Je draait al de nieuwste firmware op kanaal ${e}.`:"Kies een kanaal en controleer of er een nieuwere firmware klaarstaat."}function Em(){return!!(o.firmwareAdvancedOpen||o.firmwareConnectionSwitchOpen||o.firmwareTopologySwitchOpen||o.updateManualUploadOpen||o.updateTestFirmwareOpen)}function ui(e,t,r,n,a=!1){return`
      <button
    ...
    `}function aS(){if(!o.updateTestFirmwareOpen)return"";let t=!!(qt()||o.updateInstallBusy||ut()),r=ur(),n=zr(),a=Bn(r,n),i=!!(n.available&&v("firmwareTestOtaUrl")&&v("firmwareTestOtaMd5Url")&&v("installFirmwareTestOta")),l=!!(r&&i),c=o.updateTestFirmwareBuild||null,u=n.available?n.label:n.error,d=a?n.otaFileName:"Vul een PR-nummer in om de OTA-build te kiezen.";return`
      <div class="oq-firmware-advanced-detail">
        <div class="oq-firmware-advanced-detail-head">
  ...
  `}function uS(){if(!o.root)return;if(o.interfacePanelOpen){f();return}let e=o.root.querySelector(".oq-helper-hub--collapsed .oq-helper-hub-head-actions");if(!e)return;let t=e.querySelector(".oq-debug-recording-header-status"),r=Xl();if(!r){t?.remove();return}if(t){t.outerHTML=r;return}e.insertAdjacentHTML("afterbegin",r)}function dS(){if(!o.root)return;let e=o.root.querySelector('[data-oq-diagnostics-row="debugRecording"]');if(!e)return;let t=e.querySelector(".oq-settings-system-row-value"),r=e.querySelector(".oq-settings-system-row-note");t&&(t.textContent=Qn()),r&&(r.textContent=bi())}function ec(e){let t={activity:'<svg viewBox="0 0 24 24" focusable="false"><path d="M3 12h4l2-7 4 14 2-7h6"/></svg>',status:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="4"/></svg>',clock:'<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="8"/><path d="M12 7v5l3 2"/></svg>',samples:'<svg viewBox="0 0 24 24" focusable="false"><path d="M4 16h3l2-7 4 9 2-5h5"/></svg>',changes:'<svg viewBox="0 0 24 24" focusable="false"><path d="M18 8a7 7 0 1 0 1 7"/><path d="M18 4v4h-4"/></svg>',file:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 3h7l4 4v14H7z"/><path d="M14 3v5h5"/></svg>',storage:'<svg viewBox="0 0 24 24" focusable="false"><ellipse cx="12" cy="6" rx="7" ry="3"/><path d="M5 6v6c0 1.7 3.1 3 7 3s7-1.3 7-3V6"/><path d="M5 12v6c0 1.7 3.1 3 7 3s7-1.3 7-3v-6"/></svg>',play:'<svg viewBox="0 0 24 24" focusable="false"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg viewBox="0 0 24 24" focusable="false"><path d="M7 7h10v10H7z"/></svg>',download:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 4v10"/><path d="m8 10 4 4 4-4"/><path d="M5 19h14"/></svg>',copy:'<svg viewBox="0 0 24 24" focusable="false"><rect x="8" y="8" width="10" height="10" rx="2"/><path d="M6 14H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v1"/></svg>',check:'<svg viewBox="0 0 24 24" focusable="false"><path d="m5 13 4 4L19 7"/></svg>',alert:'<svg viewBox="0 0 24 24" focusable="false"><path d="M12 8v5"/><path d="M12 17h.01"/><path d="M10.3 4.7 2.8 18a2 2 0 0 0 1.7 3h15a2 2 0 0 0 1.7-3L13.7 4.7a2 2 0 0 0-3.4 0z"/></svg>'};return t[e]||t.status}function pS(e){return`<span class="oq-debug-recording-icon" aria-hidden="true">${ec(e)}</span>`}function no(e){return`<span class="oq-debug-recording-button-icon" aria-hidden="true">${ec(e)}</span>`}function mS(){return[...Bo]}function gS(){let e=[];return Bo.forEach((t,r)=>{let n=o.entities?.[t]||{},a=String(n.uom??n.unit_of_measurement??"").trim();a&&e.push([r,a])}),e}function fS(e){return Array.isArray(e)?e.map((t,r)=>t===null?null:[r,t]).filter(Boolean):[]}function wi(){o.debugRecordingTimer&&(window.clearTimeout(o.debugRecordingTimer),o.debugRecordingTimer=null)}function fr(){o.debugRecordingDevicePollTimer&&(window.clearTimeout(o.debugRecordingDevicePollTimer),o.debugRecordingDevicePollTimer=null)}function Ro(e){return`${De()}/openquatt/debug-recording/${e}`}function Gr(e){let t=e&&typeof e=="object"?e:{};o.debugRecordingDeviceStatus=t,o.debugRecordingActive=!!t.active,o.debugRecordingStartedAt=t.active||Number(t.sample_count||0)>0?Date.now()-Math.max(0,Number(t.elapsed_s||0)*1e3):0,o.debugRecordingEndsAt=t.active?Date.now()+Math.max(0,Number(t.remaining_s||0)*1e3):0,o.debugRecordingLastSampleAt=Number(t.sample_count||0)>0?Date.now():0}function tc(){Gr({ok:!1,available:!1,active:!1,mode:"manual",rolling:!1,frozen:!1,storage:"unavailable",interval_s:0,duration_s:0,elapsed_s:0,remaining_s:0,sample_count:0,sample_capacity:0,estimated_size:0,buffer:"unavailable"})}async function hS(){let e=await window.fetch(Ro("status"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();return Gr(t),t}function Yn(e=2e3){fr(),o.debugRecordingActive&&(o.debugRecordingDevicePollTimer=window.setTimeout(()=>{yi({silent:!0})},Math.max(0,Number(o.systemModal==="debug-recording"?e:5e3)||0)))}async function yi(e={}){e.silent||(o.debugRecordingBusy=!0,o.debugRecordingError="",f());try{await hS(),!o.debugRecordingActive&&e.silent&&(o.debugRecordingNotice="Debugopname is afgerond."),Yn()}catch(t){tc(),o.debugRecordingError=`Status kon niet worden opgehaald. ${t.message||String(t)}`}finally{e.silent||(o.debugRecordingBusy=!1),!e.silent||o.systemModal==="debug-recording"?f():(uS(),dS())}}async function Dm(){let e=Hl(Bo,"state"),t=null;for(let r=0;r<e.length;r+=1){let n=await window.fetch(Ro(`configure?reset=${r===0?"1":"0"}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store","Content-Type":"application/x-www-form-urlencoded"},body:e[r].body});if(!n.ok)throw new Error(`configuratie HTTP ${n.status}`);t=await n.json()}if(Number(t?.entity_field_count||0)!==Bo.length)throw new Error(`onvolledige debugset (${Number(t?.entity_field_count||0)}/${Bo.length})`);return t}async function bS(e){let t=Math.max(1,Number(e)||15);wi(),fr(),Ga({debugRecordingBusy:!0,debugRecordingError:"",debugRecordingNotice:"",debugRecordingSamples:[],debugRecordingEvents:[],debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingDeviceBundle:null,debugRecordingLastSampleAt:0,debugRecordingSequence:0}),f();try{await Dm();let r=await window.fetch(Ro(`start?duration_s=${encodeURIComponent(t*60)}`),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!r.ok)throw new Error(`HTTP ${r.status}`);let n=await r.json();Gr(n),Yn()}catch(r){tc(),o.debugRecordingError=`Debugopname kon niet worden gestart. ${r.message||String(r)}`}finally{o.debugRecordingBusy=!1,f()}}async function wS(){wi(),fr(),Ga({debugRecordingBusy:!0,debugRecordingError:"",debugRecordingNotice:"",debugRecordingSamples:[],debugRecordingEvents:[],debugRecordingInitialValues:null,debugRecordingLastValues:null,debugRecordingDeviceBundle:null,debugRecordingLastSampleAt:0,debugRecordingSequence:0}),f();try{await Dm();let e=await window.fetch(Ro("start?rolling=1"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();Gr(t),Yn()}catch(e){tc(),o.debugRecordingError=`Rolling debug kon niet worden gestart. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,f()}}async function yS(){let e=await window.fetch(Ro("freeze"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!e.ok)throw new Error(`HTTP ${e.status}`);let t=await e.json();return Gr(t),fr(),t}async function vS(){wi(),o.debugRecordingBusy=!0,o.debugRecordingError="",f();try{await yS(),o.debugRecordingNotice="Rolling debug is gestopt. De recente buffer blijft bewaard."}catch(e){o.debugRecordingError=`Rolling debug kon niet worden gestopt. ${e.message||String(e)}`}finally{o.debugRecordingBusy=!1,f()}}async function SS(e={}){wi(),fr(),o.debugRecordingBusy=!0,o.debugRecordingError="",f();try{let t=await window.fetch(Ro("stop"),{method:"POST",cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();Gr(r),o.debugRecordingNotice=e.completed?"Debugopname is afgerond.":"Debugopname is gestopt."}catch(t){o.debugRecordingError=`Debugopname kon niet worden gestopt. ${t.message||String(t)}`}finally{o.debugRecordingBusy=!1,f()}}function xm(e={}){let t=o.debugRecordingActive?Date.now():Number(o.debugRecordingLastSampleAt||Date.now());return{format:"openquatt-debug-v2",schema_version:2,kind:"openquatt_debug_recording",encoding:"column-delta-json-v2",exported_at:new Date().toISOString(),source:e.source||{},recording:{started_at:o.debugRecordingStartedAt?new Date(Number(o.debugRecordingStartedAt)).toISOString():"",ended_at:t?new Date(t).toISOString():"",active:!!o.debugRecordingActive,duration_s:o.debugRecordingStartedAt?Math.round(Math.max(0,t-Number(o.debugRecordingStartedAt))/1e3):0,interval_s:Math.round(Xu/1e3),sample_count:It(),column_count:Bo.length,storage:"browser"},columns:mS(),units:gS(),initial:fS(o.debugRecordingInitialValues),samples:o.debugRecordingSamples||[],events:o.debugRecordingEvents||[],...e.logs?{logs:e.logs}:{}}}function fi(e){return JSON.stringify(e)}function qS(){let e=Number(o.debugRecordingDeviceStatus?.estimated_size||0);if(e>0)return e;try{return new Blob([fi(xm())]).size}catch{return fi(xm()).length}}function kS(e){let t=Math.max(0,Number(e)||0);return t>=1024*1024?`${(t/1024/1024).toFixed(1)} MB`:t>=1024?`${(t/1024).toFixed(1)} kB`:`${Math.round(t)} B`}function TS(e){let t=e?.exported_at||(e?.exported_at_ms?new Date(Number(e.exported_at_ms)).toISOString():new Date().toISOString()),r=String(t).replace(/[:.]/g,"-").replace(/T/,"_").replace(/Z$/,"Z");return`${String(e?.source?.installation||"OpenQuatt").replace(/\s+/g,"-").toLowerCase()}-debug-recording-${r}.oqdebug.json`}async function ES(){if(It()===0){o.debugRecordingError="Er is nog geen debugopname om te downloaden.",f();return}o.debugRecordingBusy=!0,o.debugRecordingError="";let e=o.debugRecordingActive&&Ft();f();try{let t=await window.fetch(Ro("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();o.debugRecordingDeviceBundle=r,Bs(TS(r),fi(r),"application/json"),_m(r),o.debugRecordingNotice=e?"Momentopname gedownload. Rolling debug loopt door.":"Supportbestand gedownload."}catch{o.debugRecordingError="Download mislukt. Probeer opnieuw of kopieer de data."}finally{o.debugRecordingBusy=!1,f()}}async function CS(){if(It()===0){o.debugRecordingError="Er is nog geen debugopname om te kopi\xEBren.",f();return}o.debugRecordingBusy=!0,o.debugRecordingError="";let e=o.debugRecordingActive&&Ft();f();try{let t=await window.fetch(Ro("download"),{cache:"no-store",headers:{"Cache-Control":"no-store"}});if(!t.ok)throw new Error(`HTTP ${t.status}`);let r=await t.json();if(o.debugRecordingDeviceBundle=r,!await wo(fi(r)))throw new Error("Kopi\xEBren naar het klembord is niet gelukt.");_m(r),o.debugRecordingNotice=e?"Momentopname gekopieerd. Rolling debug loopt door.":"Supportbestand gekopieerd."}catch{o.debugRecordingError="Kopi\xEBren mislukt. Probeer opnieuw of download het supportbestand."}finally{o.debugRecordingBusy=!1,f()}}var xS={"open-debug-recording-modal":()=>(o.systemModal="debug-recording",o.debugRecordingError="",o.debugRecordingNotice="",f(),yi()),"start-debug-recording":e=>bS(e.dataset.debugMinutes||15),"start-rolling-debug-recording":()=>wS(),"select-debug-recording-duration":e=>lS(e.dataset.debugMinutes||15),"stop-debug-recording":()=>SS(),"freeze-debug-recording":()=>vS(),"download-debug-recording":()=>ES(),"copy-debug-recording":()=>CS()};function Pm(e,t){return se(xS,e,t)}function Nm(){let e=o.debugRecordingActive,t=Ft(),r=hi(),n=It(),a=o.debugRecordingBusy,i=kS(qS()),l=Array.isArray(o.debugRecordingDeviceBundle?.events)?o.debugRecordingDeviceBundle.events.length:Array.isArray(o.debugRecordingEvents)?o.debugRecordingEvents.length:0,c=sS(),u=Rm(),d=$m(),m=cS(),w=n>0,y=`${m.toFixed(1)}%`,h=[{icon:"status",label:"Status",value:Qn()},{icon:"clock",label:t?"Retentie":"Duur",value:gr(t?d:Mm())},{icon:"samples",label:"Samples",value:String(n)},{icon:"changes",label:"Statuswijzigingen",value:String(l)},{icon:"file",label:"Geschatte grootte",value:`\xB1 ${i}`},{icon:"storage",label:"Opslag",value:o.debugRecordingDeviceStatus?.available===!1?"Niet beschikbaar":"Apparaatgeheugen"}],g=o.debugRecordingError?{kind:"error",icon:"alert",text:o.debugRecordingError}:o.debugRecordingNotice?{kind:"success",icon:"check",text:o.debugRecordingNotice}:null;return te({id:"system",titleId:"oq-debug-recording-modal-title",kicker:"Diagnostiek",title:"Debugopname",copy:bi(),className:"oq-debug-recording-modal",closeAction:"close-system-modal",closeLabel:"Sluit debugopname",body:`
          ...
          ${e?`
            <div class="oq-debug-recording-progress">
              <div class="oq-debug-recording-progress-head">
                <span>${s(t?`Laatste ${gr(d)} bewaard`:`Nog ${gr(u)}`)}</span>
    ...
    `}function Gm(){let e=v("boilerCvAssistEnabled")&&C("boilerCvAssistEnabled"),t=ii(),r=C("cm100Active"),n=String(t||"").trim().toUpperCase(),a=hr(t),i=!a&&(r||n==="CM100 READY"),l=o.commissioningTaskLock==="cm100",c=o.loadingEntities||o.busyAction==="commissioningCm100Start"||o.busyAction==="commissioningCm100Stop"||l,u=!!o.pendingCommissioningCm100Start,d=c||i||a,m=c||!i,w=ar("boilerPowerTestStatus","IDLE"),y=ki(w,"boiler"),h=C("boilerPowerTestActive"),g=o.loadingEntities||o.busyAction==="boilerPowerTestStart"||o.busyAction==="boilerPowerTestAbort"||o.busyAction==="boilerPowerTestApply",p=!!(o.entities.boilerPowerTestStart||o.entities.boilerPowerTestAbort||o.entities.boilerPowerTestApply),b=!!o.pendingBoilerPowerTestStart,S=o.commissioningTaskLock==="boiler",q=hr(w),k=!Ce(w)&&(h||b||S||Jr(w))&&!q,M=Re("boilerRatedHeatPower"),R=Re("boilerHeatPower"),_=H("boilerHeatPower"),W=_>0?R:k&&o.commissioningBoilerHeatPowerDisplay?o.commissioningBoilerHeatPowerDisplay:R;_>0&&(o.commissioningBoilerHeatPowerDisplay=R);let I=ar("flowAutotuneStatus","IDLE"),j=ki(I,"autotune"),x=o.loadingEntities||o.busyAction==="flowAutotuneStart"||o.busyAction==="flowAutotuneAbort"||o.busyAction==="flowAutotuneApply",P=!!(o.entities.flowAutotuneStart||o.entities.flowAutotuneAbort||o.entities.flowAutotuneApply),D=!!o.pendingFlowAutotuneStart,N=o.commissioningTaskLock==="autotune",J=hr(I),V=!Ce(I)&&(D||N||Jr(I))&&!J,X=ar("airPurgeStatus","IDLE"),Ne=ki(X,"purge"),Et=C("airPurgeActive"),ft=o.loadingEntities||o.busyAction==="airPurgeStart"||o.busyAction==="airPurgeAbort",lo=!!(o.entities.airPurgeStart||o.entities.airPurgeAbort),Ct=!!o.pendingAirPurgeStart,Oe=o.commissioningTaskLock==="purge",de=!Ce(X)&&(Et||Ct||Oe||Jr(X)),yn=/DONE/.test(String(X||"").toUpperCase()),$r=!!(lo||o.entities.airPurgeStatus||o.entities.airPurgeReturnToAuto),$=Re("airPurgeRemaining",{decimals:0}),A=H("airPurgePhase"),z=A===1?"Rustig":A===2?"Pulsen":A===3?"Stabiliseren":Ne.phase,B=ar("manualFlowStatus","IDLE"),ee=C("manualFlowActive"),ne=o.loadingEntities||o.busyAction==="manualFlowStart"||o.busyAction==="manualFlowAbort",me=!!(o.entities.manualFlowStart||o.entities.manualFlowAbort),ge=!!o.pendingManualFlowStart,ce=o.commissioningTaskLock==="manual-flow",fe=!Ce(B)&&(ee||ge||ce||Jr(B)),Ye=ar("manualHpStatus","IDLE"),co=C("manualHpActive"),He=o.loadingEntities||o.busyAction==="manualHpStart"||o.busyAction==="manualHpAbort",uo=!!(o.entities.manualHpStart||o.entities.manualHpAbort),po=!!o.pendingManualHpStart,Be=o.commissioningTaskLock==="manual-hp",xe=!Ce(Ye)&&(co||po||Be||Jr(Ye)),vn=/SAFETY STOP/.test(String(Ye||"").toUpperCase()),Ke=/STOPPING/.test(String(Ye||"").toUpperCase()),go=ar("hpWaterCalibrationStatus","IDLE"),Ob=ki(go,"hp-water-calibration"),Fu=C("hpWaterCalibrationActive"),xa=o.loadingEntities||o.busyAction==="hpWaterCalibrationStart"||o.busyAction==="hpWaterCalibrationAbort"||o.busyAction==="hpWaterCalibrationApply",Wu=!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort||o.entities.hpWaterCalibrationApply),$a=!!o.pendingHpWaterCalibrationStart,fo=o.commissioningTaskLock==="hp-water-calibration",Je=!Ce(go)&&(Fu||$a||fo||Jr(go)),Ma=/DONE|APPLIED/.test(String(go||"").toUpperCase()),ju=/APPLIED/.test(String(go||"").toUpperCase()),Lb=Re("flowKpSuggested",{decimals:5,trimTrailingZeros:!0}),Ib=Re("flowKiSuggested",{decimals:5,trimTrailingZeros:!0}),Vu=/DONE|APPLIED/.test(String(w||"").toUpperCase()),Bu=/DONE|APPLIED/.test(String(I||"").toUpperCase()),ws=i?q?"Wachten op CM100":k?y.phase:Vu?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",ys=i?J?"Wachten op CM100":V?j.phase:Bu?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",vs=i?de?Ne.phase:yn?"Klaar":"Klaar om te starten":"Wachten op CM100",Ku=i?fe?"Actief":"Klaar om te starten":"Wachten op CM100",zu=i?xe?Ke?"Bezig met stoppen":vn?"Veiligheidsstop":"Actief":"Klaar om te starten":"Wachten op CM100",Uu=i?Je?Ob.phase:ju?"Offsets toegepast":Ma?"Klaar om toe te passen":"Klaar om te starten":"Wachten op CM100",Gu=!i||g||!p||V||de||fe||xe||Je||k||N||Oe||ce||Be||fo||b,Fb=g||!(k||S||b),Wb=g||Gu||!Vu||V||de||Je,Qu=!i||x||!P||k||de||fe||xe||Je||V||S||Oe||ce||Be||fo||D,jb=x||!(V||N||D),Vb=x||Qu||!Bu||k||de||Je,Bb=!i||ft||!lo||k||V||fe||xe||Je||de||S||N||ce||Be||fo||Ct,Kb=ft||!(de||Oe||Ct),zb=!i||ne||!me||k||V||de||xe||Je||fe||S||N||Oe||Be||fo||ge,Ub=ne||!(fe||ce||ge),Gb=!i||He||!uo||k||V||de||fe||Je||xe||S||N||Oe||ce||fo||po,Qb=He||!(xe||Be||po),Yb=!i||xa||!Wu||k||V||de||fe||xe||Je||S||N||Oe||ce||Be||$a,Jb=xa||!(Je||fo||$a),Zb=xa||Je||!Ma||ju;u&&i&&(o.pendingCommissioningCm100Start=!1),l&&(i||/READY|STOPPED|DONE|FAILED|ABORT|APPLIED|REFUSED/.test(n))&&(o.commissioningTaskLock=""),b&&(h||Ce(w))&&(o.pendingBoilerPowerTestStart=!1),S&&Ce(w)&&(o.commissioningTaskLock=""),D&&Ce(I)&&(o.pendingFlowAutotuneStart=!1),N&&Ce(I)&&(o.commissioningTaskLock=""),Ct&&(Et||Ce(X))&&(o.pendingAirPurgeStart=!1),Oe&&Ce(X)&&(o.commissioningTaskLock=""),ge&&(ee||Ce(B))&&(o.pendingManualFlowStart=!1),ce&&(ee||Ce(B))&&(o.commissioningTaskLock=""),po&&(co||Ce(Ye))&&(o.pendingManualHpStart=!1),Be&&(co||Ce(Ye))&&(o.commissioningTaskLock=""),$a&&(Fu||Ce(go))&&(o.pendingHpWaterCalibrationStart=!1),fo&&Ce(go)&&(o.commissioningTaskLock="");let Xb=a?"Wachten op CM100":t,ew=a?"Service-stand wordt geopend. Wacht tot CM100 klaar staat.":i?"CM100 is actief en klaar voor service-taken.":"Start de service-stand voordat je een taak uitvoert.",tw=[{key:"hp-water-calibration",title:"Temperatuursensoren kalibreren",label:"Sensor kalibratie",summary:"Laat de waterpomp draaien zonder compressor en bepaal offsets voor HP1/HP2 water in/out.",status:Uu,available:!!(Wu||o.entities.hpWaterCalibrationStatus),openDisabled:!i,cardMarkup:Zr({taskKey:"hp-water-calibration",title:"Temperatuursensoren kalibreren",copy:"Doorloop voorbereiding, meting en toepassen in vaste volgorde. De meting stopt eerder zodra de sensoren stabiel genoeg zijn.",subcopy:"De voorgestelde waarden worden pas actief wanneer je ze toepast; supply blijft een diagnosewaarde.",status:Uu,statusCopy:Je?"De pomp draait en de firmware wacht op een stabiel temperatuurbeeld.":Ma?"Controleer de voorgestelde offsets voordat je ze toepast.":i?"CM100 staat klaar. Start de meting wanneer compressor en boiler uit zijn.":"Start CM100 eerst.",progressTask:"hp-water-calibration",controls:zS({status:go,running:Je,resultReady:Ma,startDisabled:Yb,abortDisabled:Jb,applyDisabled:Zb,busy:xa,controlsAvailable:!!(o.entities.hpWaterCalibrationStart||o.entities.hpWaterCalibrationAbort)}),className:"oq-settings-commissioning-card--hp-water-calibration"})},{key:"manual-flow",title:"Handmatige flowregeling",label:"Handmatige flow",summary:"Laat de waterpomp draaien op een tijdelijk flow-setpoint en luister naar het leidingwerk.",status:Ku,available:!!(me||o.entities.manualFlowStatus),openDisabled:!i,cardMarkup:Zr({taskKey:"manual-flow",title:"Handmatige flowregeling",copy:"Gebruik een tijdelijk flow-setpoint om het leidingwerk rustig te controleren. De normale instellingen wijzigen pas wanneer je een waarde bewust overneemt.",subcopy:"De bestaande PI-regeling blijft de pomp aansturen.",status:Ku,statusCopy:fe?"De waterpomp draait. Pas het tijdelijke setpoint aan en controleer de gemeten flow.":i?"CM100 staat klaar. Kies een tijdelijk setpoint en start de waterpomp.":"Start CM100 eerst.",progressTask:"",controls:`
        ...
        `},{key:"manual-hp",title:"Handmatige warmtepompbediening",label:"Handmatige warmtepomp",summary:"Selecteer een werkmodus en vraag per warmtepomp een compressorstand aan binnen de bestaande bewaking.",status:zu,available:!!(uo||o.entities.manualHpStatus),openDisabled:!i,cardMarkup:Zr({taskKey:"manual-hp",title:"Handmatige warmtepompbediening",copy:"Start eerst de service-taak zodat de waterpomp draait. Zodra voldoende flow is gemeten kun je per warmtepomp vanuit Standby naar verwarmen of koelen schakelen en daarna een compressorstand aanvragen.",subcopy:"Low-flow, maximale watertemperatuur, minimum draaitijd, minimum uit-tijd en veilige modusovergangen blijven actief. De koelvloer, silent-modus, dag/nacht-cap en normaal uitgesloten compressorstanden worden voor deze handmatige test bewust genegeerd.",status:zu,statusCopy:xe?Ke?"De compressorvraag staat op 0. De waterpomp blijft draaien totdat de minimale draaitijd veilig is afgerond.":vn?"De bewaking heeft de aangevraagde standen teruggezet naar 0. Controleer de oorzaak voordat je opnieuw opschaalt.":"De service-taak is actief. Een veiligheidsstop zet de aangevraagde standen terug naar 0; opnieuw opschalen vereist een bewuste handeling.":i?"CM100 staat klaar. Start de taak om handmatige warmtepompbediening vrij te geven.":"Start CM100 eerst.",progressTask:"",actions:`
          ...
          `})}].filter(ow=>ow.available);return{cm100Status:Xb,cm100StartDisabled:d,cm100StopDisabled:m,serviceStatusCopy:ew,tasks:tw}}function US(e){return Ie({dataAttribute:"data-oq-service-task",dataValue:e.key,className:"oq-settings-service-row",label:e.label,value:e.status,note:e.summary,action:`<button
          class="oq-helper-button oq-helper-button--ghost"
          type="button"
...
Alle bewaarde dagtotalen worden verwijderd. Dit heeft geen invloed op de werking van je warmtepomp.`))return e("lifetimeEnergyHistoryClear",{successNotice:"Energiehistorie is gewist.",errorPrefix:"Energiehistorie kon niet worden gewist",refreshKeys:Xt(),refreshDelayMs:500}).then(()=>{o.energyHistoryRaw="",o.energyHistorySignature="",o.energyHistoryLastFetchAt=0,_o(),o.appView==="results"&&yr({force:!0}).then(()=>f())})},"select-energy-history-import-file":()=>Eq(),"clear-energy-history-import-file":()=>{bg(),f()},"import-energy-history-file":()=>Cq(),"export-energy-history":()=>dq(),"open-history-storage-modal":()=>{o.settingsStoragePage="overview",o.systemModal="history-storage",f();let e=Pi({forceMissing:!0,forceTrendHistory:!0,forceDecisionLog:!0,forceEnergyHistory:!0}).finally(()=>{o.systemModal==="history-storage"&&f()});return _o([1e3,3e3,7e3]),e},"open-storage-diagnosis":()=>{o.settingsStoragePage="diagnosis",f()},"open-storage-decision-log":()=>{o.settingsStoragePage="decision-log",f()},"open-storage-energy":()=>{o.settingsStoragePage="energy",f()},"back-storage-overview":()=>{o.settingsStoragePage="overview",f()},"download-settings-backup":()=>_q(),"open-settings-backup-import":()=>{o.settingsBackupMqttPassword="",o.settingsBackupRestoreResult=null,o.settingsBackupError="",o.systemModal="settings-backup-import",f()},"confirm-settings-backup-restore":()=>Lq()};function Mg(e,t){return se(Iq,e,t)}function vc(e,t,r="",n=!1){return`
    ...
    `:""}function Ng(){if(!v("trendHistoryEnabled")&&!v("decisionLogHistoryEnabled")&&!v("lifetimeEnergyHistoryEnabled"))return"";let e=C("trendHistoryEnabled"),t=e&&C("trendHistoryFlashEnabled"),r=v("lifetimeEnergyHistoryEnabled"),n=r&&C("lifetimeEnergyHistoryEnabled"),a=v("decisionLogHistoryEnabled"),i=a&&C("decisionLogHistoryEnabled"),l=Dg(),c=t?je("trendHistoryFlashAvailable","Alleen live"):"Alleen live",u=r?Rg(je("lifetimeEnergyHistoryAvailable","Geen data")):"Geen data";return re("Diagnose","Gegevens bewaren","Bepaal welke gegevens OpenQuatt bewaart voor grafieken, resultaten en hulp bij problemen.",`
        <article class="oq-settings-storage-summary">
          ...
          <div class="oq-settings-storage-summary-metrics" aria-label="Opslagstatus">
            ...
            ${r?vc("Energie",u,n?"Blijft bewaard na herstart":"Uit",n):""}
          </div>
    ...
    `}function Og(){let e=["diagnosis","decision-log","energy"].includes(o.settingsStoragePage)?o.settingsStoragePage:"overview",t=v("trendHistoryEnabled")&&C("trendHistoryEnabled"),r=t&&v("trendHistoryFlashEnabled")&&C("trendHistoryFlashEnabled"),n=v("decisionLogHistoryEnabled"),a=n&&C("decisionLogHistoryEnabled"),i=Dg(),l=_g(i.storedEvents),c=v("lifetimeEnergyHistoryEnabled"),u=c&&C("lifetimeEnergyHistoryEnabled"),d=c?je("lifetimeEnergyHistoryAvailable","Geen data"):"Geen data",m=Rg(d),w=v("lifetimeEnergyHistoryClear")&&!["Geen data","\u2014"].includes(d),y=t&&v("trendHistoryFlush"),h=a&&v("decisionLogHistoryFlush"),g=v("lifetimeEnergyHistoryCapture"),p=Pg(),b=String(o.energyHistoryRaw||"").includes("@hour_retention|"),S=b&&!p.hourPartitionAvailable,q=b?S?"Alleen live":Hg(p.hourStoredDayCount,"Geen uurdata"):"Laden...",T=b&&!S?Ii(p.hourStorageKb):"\u2014",k=b&&!S?la(p.hourWriteCount):"\u2014",M=b&&!S?Li(p.hourLastWriteTimestampS):"Geen data",R=e==="overview"?"":`
      ...
      ${v("decisionLogHistoryClear")?`<details class="oq-settings-storage-advanced"${o.settingsStorageAdvancedOpen?" open":""}><summary data-oq-action="toggle-storage-advanced">Geavanceerd</summary><div class="oq-settings-storage-inline-action oq-settings-storage-inline-action--danger"><div><h4>Beslisloghistorie wissen</h4><p>Verwijder alle bewaarde gebeurtenissen. De actuele beslislog blijft staan.</p></div>${sa("decisionLogHistoryClear","Historie wissen","clear-decision-log-history",{disabled:Number(i.storedEvents||0)<=0,buttonClass:"oq-helper-button oq-helper-button--warning",busyLabel:"Wissen..."})}</div></details>`:""}`):e==="energy"&&(x="Energiehistorie",P="Beheer dagtotalen en uurdetail voor de Resultatenpagina.",D=`${R}<section class="oq-settings-storage-domain oq-settings-storage-domain--single">
        <div class="oq-settings-storage-domain-rows">
          ...
          ${g?`<div class="oq-settings-storage-inline-action"><div><h4>Vandaag alvast opslaan</h4><p>Maak v\xF3\xF3r een update of herstart een extra opslagmoment.</p></div>${sa("lifetimeEnergyHistoryCapture","Vandaag opslaan","save-lifetime-energy-history",{disabled:!u,busyLabel:"Opslaan..."})}</div>`:""}
        </div>
      </section>${Sc(j)}
      ...
      <div class="oq-ph-concept-card">
        <div class="oq-ph-concept-visual">
          ...
          <svg class="oq-ph-concept-svg" viewBox="0 0 ${c} ${u}" role="img" aria-label="Grafiek voor Power House tuning">
            ...
            <rect x="${R.toFixed(1)}" y="${w}" width="${Math.max(20,T-R).toFixed(1)}" height="${(u-w-y).toFixed(1)}" rx="18" class="oq-ph-concept-band oq-ph-concept-band--above"></rect>
            ...
            ${W?`<text x="${R+5}" y="${u-14}" text-anchor="start" class="oq-ph-concept-tick-value">${s(U(l,1,"\xB0C"))}</text>`:""}
          </svg>
        </div>
    ...
    `:""}function Gg(){let e=Zq();return re("Installatie","Flowregeling","Kies hoe de pomp wordt geregeld en stel de flow-instellingen direct als installatieparameter in. De autotune vind je later bij Service & commissioning.",`
      ...
      `;return re("Regeling","Verwarmingsstrategie","Kies hier hoe OpenQuatt je verwarming regelt. De instellingen hieronder passen zich automatisch aan.",`
        ...
        ${Mc()}
        ${e}
      `)}function _c(){let r={top:22,right:18,bottom:38,left:34},n=560-r.left-r.right,a=240-r.top-r.bottom,i=ye[0].outdoor,l=ye[ye.length-1].outdoor,c=h=>r.left+(h-i)/(l-i)*n,u=h=>r.top+(70-h)/50*a,d=[20,30,40,50,60,70].map(h=>{let g=u(h);return`
      ...
      `).join(""),w=ye.map(h=>`${c(h.outdoor)},${u(ve(h.key,E(h.key)))}`).join(" "),y=ye.map(h=>{let g=ve(h.key,E(h.key));return`
          <g>
            <circle
              cx="${c(h.outdoor)}"
              cy="${u(g)}"
      ...
      <article class="oq-settings-odu-runtime-panel">
        <div class="oq-settings-odu-runtime-panel-head">
          ...
          <div class="oq-settings-odu-runtime-actions">
            ${v(r)?tt(r,o.busyAction===r?"Lezen...":"Uit ODU laden","oq-helper-button oq-helper-button--ghost",d):""}
      ${v(t)?vt(t,`HP${e} writes vrijgeven`,u,d,"Enable","Locked"):""}
...
Kenmerken: Flowmeter in de buitenunit ge\xEFntegreerd. Onder CV-ketel enkel een kleine clip-on temperatuursensor.`}},t=o.entities.hpGeneration||{},r=String(E("hpGeneration")||""),n=Ot(t),a=o.loadingEntities||o.busyAction==="save-hpGeneration";return`
    ...
    `}function nf(){let e=Nt(),t=o.entities.hpGeneration||{},r=v("hpGeneration")&&Ot(t).length>0;return!e&&!r?"":re("Basis","Quatt Hybrid-versie","Kies hier welke Quatt Hybrid je hebt. Deze keuze bepaalt de basis van de regeling.",`
      ...
      `)}function Pc(e="oq-settings-grid oq-settings-boiler-simple-grid"){if(!v("boilerCvAssistEnabled"))return"";let t=C("boilerCvAssistEnabled"),r=v("boilerRatedHeatPower"),n=ze("boilerRatedHeatPower"),a=Ae("boilerRatedHeatPower"),i=o.loadingEntities||o.busyAction==="switch-boilerCvAssistEnabled",l=v("boilerConnection"),c=l?String(E("boilerConnection")||"R1"):"R1",u=Yg({linkEntityPresent:v("otbLinkAvailable"),linkEntityConfirmedMissing:!!o.optionalMissingEntities?.otbLinkAvailable}),d=u===Do.SUPPORTED,m=u!==Do.UNKNOWN,w=l?Jg(Ot(o.entities.boilerConnection||{}),u):[],y=l&&m?`
      <label class="oq-settings-control oq-settings-control--select">
        <select class="oq-helper-select" data-oq-field="boilerConnection" ${o.loadingEntities?"disabled":""}>
          ${w.map(b=>`
            <option value="${s(b)}" ${b===c?"selected":""}>
              ${s(b==="OpenTherm"?"OpenTherm (OTB)":"Aan/uit (R1)")}
            </option>
          `).join("")}
        </select>
        <span class="oq-settings-select-caret" aria-hidden="true"></span>
    ...
    `:"",g=r?Eo({key:"boilerRatedHeatPower",value:a,meta:n,controlClass:"oq-helper-control oq-helper-control--suffix oq-settings-boiler-power-control",unitMarkup:'<span class="oq-helper-unit-chip">W</span>'}):`
  ...
  `}function dk(){let e=oe(),t=lt(),r=`${e}:${t}`,n=o.quickStartSetupDraft||r,[a,i]=n.split(":");return{...mi(a,i),currentKey:r,selectedKey:n,changes:n!==r,targetIsDuo:a==="duo",targetIsEthernet:i==="eth"}}function pk(){let e=dk(),t=qt(),r=!!(t||o.updateInstallBusy),n=[["single:wifi","Single \xB7 Wi-Fi","E\xE9n warmtepomp via het draadloze netwerk."],["single:eth","Single \xB7 Ethernet","E\xE9n warmtepomp via een vaste netwerkkabel."],["duo:wifi","Duo \xB7 Wi-Fi","Twee warmtepompen via het draadloze netwerk."],["duo:eth","Duo \xB7 Ethernet","Twee warmtepompen via een vaste netwerkkabel."]],a=[e.targetIsDuo?"De tweede warmtepomp is aangesloten en hoort bij deze controller.":"Deze controller wordt voor \xE9\xE9n warmtepomp gebruikt.",e.targetIsEthernet?"De netwerkkabel is aangesloten.":"De Wi-Fi-gegevens zijn beschikbaar op de controller."];return`
    ...
    `}function Tk(){let e=wf().id;return e==="setup"?pk():e==="generation"?pf():e==="boiler"?v("boilerCvAssistEnabled")?bk():df():e==="flow-source"?gk():e==="thermostat-source"?fk():e==="flow"?wk():e==="heating"?yk():e==="water"?vk():e==="silent"?Sk():e==="usage-telemetry"?qk():e==="confirm"?kk():df()}function vr(){let e=Nc().isQEdition;return Mr.filter(t=>(t.id!=="setup"||e)&&(!t.optionalEntity||v(t.optionalEntity)))}function pt(e){let t=vr().findIndex(r=>r.id===e);return`Stap ${Math.max(0,t)+1}`}function Ek(e){let t=zi(),r=e===t,n=o.complete===!0||e<t;return{tone:r?"current":n?"done":"upcoming",label:r?"Actief":n?"Gereed":"Volgend",current:r}}function Ck(e=!1){return vr().map((t,r)=>{let n=Ek(r);return`
      ...
      `}).join("")}function wf(){let e=vr();return e.find(t=>t.id===o.currentStep)||e[0]||Mr[0]}function zi(){return Math.max(0,vr().findIndex(e=>e.id===o.currentStep))}function yf(e){let t=vr(),r=Math.min(t.length-1,Math.max(0,zi()+e));o.currentStep=t[r]?.id||Mr[0].id}function Tt(e={}){let t=zi(),r=vr(),n=t>0?r[t-1]:null,a=t<r.length-1?r[t+1]:null;return`
    ...
    `}function Lc(e){let t=String(e||"").trim();return t?{Ready:"Gereed","Waiting for room request":"Koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint","Cooling enabled, waiting for room temperature above cooling setpoint":"Koeling toegestaan, wacht op kamertemperatuur boven koel-setpoint","No dew point source":"Geen dauwpuntbron","OpenQuatt paused":"OpenQuatt gepauzeerd","Cooling disabled":"Koeling uitgeschakeld","Cooling minimum unavailable":"Minimale koel-aanvoer onbekend","Flow too low":"Flow te laag","Fallback active":"Dauwpuntsbenadering actief","Fallback active (+0.5\xB0C warm night)":"Dauwpuntsbenadering actief (+0,5\xB0C warme nacht)","Fallback active (+1.0\xB0C very warm night)":"Dauwpuntsbenadering actief (+1,0\xB0C zeer warme nacht)","Fallback active (+1.5\xB0C tropical night)":"Dauwpuntsbenadering actief (+1,5\xB0C tropische nacht)","User responsibility (no dew point or fallback)":"Expliciet toegestaan (geen dauwpunt of benadering)","Fallback cooling active":"Dauwpuntsbenadering actief","Fallback corrected by warm night":"Dauwpuntsbenadering gecorrigeerd door warme nacht","Fallback blocked by tropical night":"Dauwpuntsbenadering geblokkeerd door tropische nacht"}[t]||t:""}function vf(){let e=!v("coolingRoomRequestRequired")||C("coolingRoomRequestRequired"),t=[ue("coolingMinimumSupplyTemp","Minimale koel-aanvoer","Ondergrens voor het koeldoel. OpenQuatt gebruikt de hoogste waarde van deze instelling en de dauwpuntveilige grens."),ct("coolingDemandMax","Maximale koelsterkte","Bepaalt hoe krachtig OpenQuatt mag koelen. Lager geeft langere, rustigere runs; hoger geeft meer koelvermogen bij warm weer.","",{minLabel:"Rustig",maxLabel:"Krachtig",valueLabel:`${Y("coolingDemandMax")} max`}),ue("coolingRestartDelta","Herstartmarge watertemperatuur","Na het bereiken van het koel-aanvoerdoel start de watercyclus pas opnieuw zodra de aanvoer deze marge boven het doel ligt."),ue("coolingSafetyMargin","Dauwpunt veiligheidsmarge","Extra marge boven het geselecteerde dauwpunt voor de minimale veilige watertemperatuur.")].filter(Boolean),r=[v("coolingRoomRequestRequired")?Jp("coolingRoomRequestRequired","Koelvraag via kamerthermostaat","Aan: OpenQuatt wacht op echte koelvraag vanuit de kamer. Uit: koeltoestemming geldt direct als koelvraag.","Koelvraag start en stopt met de marges hieronder.","Koeltoestemming geldt direct als koelvraag. De start- en stopmarge worden nu niet gebruikt.","oq-settings-field--span-2"):"",e?ue("coolingRequestOnDelta","Koelvraag start boven setpoint","Koelvraag wordt actief zodra de kamer warmer is dan setpoint plus deze marge."):"",e?ue("coolingRequestOffDelta","Koelvraag stopt boven setpoint","Koelvraag valt weer af zodra de kamer koeler is dan setpoint plus deze marge."):""].filter(Boolean),n=r.length>0,a=v("coolingWithoutDewPointMode"),i=[v("coolingGuardMode")?ua("Route",ke(F("coolingGuardMode","Onbekend"))):"",v("coolingEffectiveMinSupplyTemp")?ua("Actieve ondergrens",F("coolingEffectiveMinSupplyTemp","\u2014")):""].filter(Boolean),l=i.length?he("coolingGuardStatus","Actuele beveiliging","Laat zien welke route koeling nu begrenst en welke ondergrens daadwerkelijk geldt.",`<div class="oq-settings-cooling-facts">${i.join("")}</div>`,"oq-settings-field--span-2 oq-settings-field--cooling-status"):"",c=[v("outsideTempSelected")?ua("Actuele buitentemperatuur",F("outsideTempSelected","\u2014")):"",v("coolingFallbackNightMinOutdoorTemp")?ua("Nachtminimum buitentemperatuur",F("coolingFallbackNightMinOutdoorTemp","\u2014")):"",v("coolingFallbackMinSupplyTemp")?ua("Berekende minimum watertemperatuur",F("coolingFallbackMinSupplyTemp","\u2014")):""].filter(Boolean),u=c.length?`<div class="oq-settings-cooling-fallback-metrics">${c.join("")}</div>`:"",d=a||c.length>0,w=F("coolingGuardMode","").toLowerCase().includes("fallback");if(!t.length&&!n&&!a&&!l&&!d)return"";let y={"Dew point required":"Gebruik alleen een betrouwbare dauwpuntmeting. Zonder meting blijft koeling uit.","Allow without dew point":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, use fallback":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, use dew point approximation":"Gebruik dauwpunt waar mogelijk. Zonder meting geldt de conservatieve benadering hieronder.","Allow without dew point, user responsibility":"Negeer dauwpunt en benadering; alleen de ingestelde minimale koel-aanvoer geldt."};return re("Koeling","Koelingsinstellingen","Stel hier in wanneer koelvraag ontstaat, hoe koud het water mag worden en hoeveel het water mag opwarmen voor herstart.",`
        ...
        `:""}
      `)}function Sf(){let e=v("otEnabled"),t=v("cicPollingEnabled")||v("cicFeedUrl"),r=v("cicCompatibilityMode"),n=v("otLinkProblem")||v("otbLinkAvailable")||v("boilerCommandValid")||v("cicDataStale")||v("cicJsonFeedOk");if(!e&&!t&&!r&&!n)return"";let a=Dt("cicPollingEnabled"),i=Dt("otEnabled"),c=String(E("boilerConnection")||"R1")==="OpenTherm",u=({label:T,value:k,active:M=!1})=>`
      <div class="oq-settings-integration-diagnostic-item${M?" is-warning":""}">
        <dt>${s(T)}</dt>
        <dd>${s(k)}</dd>
      </div>
    `,d=(T,k,M="Actief",R="Normaal",_={})=>{if(!v(T))return"";let W=Z(T);return u({label:k,value:W?M:R,active:_.warningWhenActive&&W||_.warningWhenInactive&&!W})},m=(T,k,M={})=>{let R=M.fallbackKey||"";return!v(T)&&!(R&&v(R))?"":u({label:k,value:Re(v(T)?T:R,M)})},w=(T,k)=>{let M=k.filter(Boolean).join("");return M?`
    ...
    `}function Zk(e){let t=Number(e.electricalInputWh||0),r=Number(e.heatOutputWh||0),n=Number(e.coolingOutputWh||0),a=Number(e.boilerOutputWh||0),i=a>0?"boiler":"boiler-zero",l=Math.max(1,t+r+n+a),c=d=>`${Math.max(0,Number(d||0)/l*100).toFixed(2)}%`,u=Uk(e);return`
...
`)}function nT(e,t=""){if(!e.length)return`
      ...
      `;let r=oT(e),n=tT(r.axisMax),a=[0,.25,.5,.75,1].map(l=>r.axisMax*l),i=e.map((l,c)=>{let u=r.left+r.barSlot*c+r.barSlot/2,d=[{key:"electricalInputWh",className:"input",label:"Verbruikte elektriciteit"},{key:"heatpumpHeatOutputWh",className:"heat",label:"Warmte door warmtepomp"},{key:"heatpumpCoolingOutputWh",className:"cooling",label:"Koeling warmtepomp"},{key:"boilerHeatOutputWh",className:"boiler",label:"Cv-ketel"}],m=r.height-r.bottom,w=d.map(p=>{let b=en(l,p.key);if(b<=0)return"";let S=b/r.axisMax*r.plotHeight;return m-=S,`
          <rect
        ...
        `}).join(""),h=e.length<=12||c===0||c===e.length-1||c%3===0?`<text x="${u.toFixed(1)}" y="${r.height-18}" text-anchor="middle" class="oq-energy-history-axis-label">${s(l.label||Wt(l.dateKey))}</text>`:"",g=rT(l);return`
    ...
    `}function OT(e){let t=e.samples[e.samples.length-1]||null,r=au(e.windowHours);return`
      <article class="oq-overview-trendcard oq-overview-trendcard--${s(e.tone)}" data-oq-trend-card="${s(e.id)}" data-render-signature="${s(MT(e))}">
    ...
    `}function ba({bind:e,modifier:t,x:r,y:n,width:a,kicker:i,detail:l,detailBind:c="",icon:u="heater",direction:d="down"}){let w=r+26,y=n+22,h=c?` data-oq-bind="${s(c)}"`:"",g="";if(d==="up"){let p=r+Math.round(a*.52);g=`M${p-6} ${n} L${p} ${n-8} L${p+6} ${n} Z`}else if(d==="left"){let p=n+Math.round(22);g=`M${r} ${p-6} L${r-8} ${p} L${r} ${p+6} Z`}else if(d==="right"){let p=n+Math.round(22);g=`M${r+a} ${p-6} L${r+a+8} ${p} L${r+a} ${p+6} Z`}else{let p=r+Math.round(a*.52);g=`M${p-6} ${n+44} L${p} ${n+44+8} L${p+6} ${n+44} Z`}return`
      <g
    ...
    `}function pu({bind:e,x:t,y:r,width:n,value:a,label:i,ariaLabel:l="",align:c="start"}){let u=l||`${i} temperatuur ${a}`,d=c==="end",m=c==="center",w=m?"middle":d?"end":"start",y=m?t+n/2:d?t+n-2:t+2;return`
      <g
    ...
    `}function uh(e,t,r,n="normal",a=null){if(!v(t.power))return"";let i=fu(e,t,r),{mode:l,defrostActive:c,running:u,thermalKey:d}=i,m=i.schematic;return o.hpVisualMode==="schematic"?`
        <section class="oq-overview-hp oq-overview-hp--${s(r)} oq-overview-hp--${s(n)}" data-oq-hp-panel="${s(e)}">
          <div class="oq-overview-hp-head">
            ...
            <div class="oq-overview-hp-head-side">
              ${uu(l,u,m.warningActive,m.failureText)}
            </div>
          </div>
          ${XT(m)}
        </section>
      ...
      <section class="oq-overview-hp oq-overview-hp--${s(r)} oq-overview-hp--${s(n)}" data-oq-hp-panel="${s(e)}">
        ...
        <div class="oq-overview-hp-stats">
          ${fa([{key:t.power,label:"Stroomverbruik",tone:"blue",note:"elektrisch verbruik"},{key:d,label:m.heatLabel,tone:"orange",note:m.heatDescription},{label:m.efficiencyLabel,value:m.efficiencyText,tone:"green",note:"actueel"}])}
        </div>
    ...
    `}function ZE(){let e=gt(),t=ka(),r=kE(),n=Oo().filter(m=>!m.quick&&!m.custom),a=TE(),i=EE(a),l=vh(a.start),c=vh(a.end),u=o.controlReplayPeriodMenuOpen,d=e==="custom"?"Eigen periode":r.some(m=>m.id===e)?"Kies periode":t.shortLabel;return`
