  ...
  export function renderBoilerWorkspace() {
    return `
      <section class="oq-helper-panel">
        ...
        <p class="oq-helper-section-copy">Geef aan of er een ketel aanwezig is, kies de fysieke aansluiting en vul het beschikbare vermogen in. Bij OpenTherm leg je ook vast of de ketel tapwater levert.</p>
